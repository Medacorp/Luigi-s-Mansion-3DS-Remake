...
execute if entity @s[tag=!charging_strobulb,scores={StrobulbCharge=10..},tag=flashlight] run function #luigis_mansion:items/flashlight/effects
execute unless entity @s[scores={StrobulbCharge=2..},tag=flashlight] run function luigis_mansion_3ds_remake:items/flashlight/effects/weak_light
