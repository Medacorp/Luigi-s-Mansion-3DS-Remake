...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[1] in minecraft:overworld run data modify block 26 0 0 Items[0].tag.value set from storage luigis_mansion:data current_state.current_data.tracking_boos[2]
...
execute if data storage luigis_mansion:data current_state.current_data.tracking_boos[0] in minecraft:overworld run data modify block 26 0 0 Items[0].tag.value set from storage luigis_mansion:data current_state.current_data.tracking_boos[2]
