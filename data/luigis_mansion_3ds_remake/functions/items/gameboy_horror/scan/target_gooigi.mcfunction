execute positioned ~-0.5 ~-0.5 ~-0.5 run tag @e[dx=0,dy=0,dz=0,tag=!scan_ignore,tag=!scanning_player,tag=!model_piece,tag=!spectator,type=!minecraft:item_frame,nbt=!{Marker:1b},limit=1] add target
