...
execute as @e[type=!minecraft:item_frame,x=724,y=28,z=-17,dx=16,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 52
