...
execute if score #fortune_tellers_room_candle_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/search/candle_2