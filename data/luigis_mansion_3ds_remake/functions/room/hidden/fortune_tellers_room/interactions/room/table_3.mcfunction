...
execute unless block 736 11 -37 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/search/boo_check/table_3
execute unless block 736 11 -36 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/search/boo_check/table_3