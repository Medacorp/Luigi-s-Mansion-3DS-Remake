...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 736 12 -36.0 run function luigis_mansion_3ds_remake:room/hidden/fortune_tellers_room/table_3
...
tag @e[x=736.5,y=11,z=-36.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
tag @e[x=736.5,y=11,z=-36.5,distance=..0.7,tag=ghost,tag=hidden] add spawn