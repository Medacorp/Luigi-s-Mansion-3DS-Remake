...
execute as @e[type=!minecraft:item_frame,x=695,y=10,z=-70,dx=17,dy=8,dz=33] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 17
