...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 704.0 14 -60.0 run function luigis_mansion_3ds_remake:room/hidden/ball_room/lamp_2
