...
function #luigis_mansion_3ds_remake:room/hidden/ball_room/turn_lights/on
tag @e[scores={Room=17},tag=ball_floor] remove enabled
execute if data storage luigis_mansion:data current_state.current_data{boos:[{}],technical_data:{released_boos_talk:1b}} run function luigis_mansion_3ds_remake:room/hidden/ball_room/load_boos
