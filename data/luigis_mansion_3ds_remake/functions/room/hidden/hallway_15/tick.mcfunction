...
execute as @e[type=!minecraft:item_frame,x=713,y=28,z=-42,dx=7,dy=8,dz=13] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 41
