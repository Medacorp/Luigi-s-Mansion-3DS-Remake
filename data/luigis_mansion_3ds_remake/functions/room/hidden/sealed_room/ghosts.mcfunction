...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.sealed_room{cleared:1b} if data storage luigis_mansion:data current_state.current_data{blackout:0b} unless score #sealed_room Wave matches 1.. run function luigis_mansion_3ds_remake:room/hidden/sealed_room/wave_1
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} unless score #sealed_room Wave matches 1.. run function luigis_mansion_3ds_remake:room/hidden/sealed_room/blackout
execute unless entity @a[scores={ScareType=3..4,Room=66},limit=1] run function luigis_mansion_3ds_remake:room/hidden/sealed_room/load_vacuumable_ghosts
