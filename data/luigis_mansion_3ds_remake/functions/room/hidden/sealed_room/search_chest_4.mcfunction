...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 695 22 -71.0 run function luigis_mansion_3ds_remake:room/hidden/sealed_room/chest_4
