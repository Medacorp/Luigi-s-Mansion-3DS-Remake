...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 704 24 -85 run function luigis_mansion_3ds_remake:room/hidden/sealed_room/trophy_3
