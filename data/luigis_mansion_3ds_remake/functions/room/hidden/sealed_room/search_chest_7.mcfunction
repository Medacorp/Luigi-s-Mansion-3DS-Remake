...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 703.0 22 -84 run function luigis_mansion_3ds_remake:room/hidden/sealed_room/chest_7
