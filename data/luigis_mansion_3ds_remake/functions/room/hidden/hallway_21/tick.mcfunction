...
execute as @e[type=!minecraft:item_frame,x=699,y=1,z=-22,dx=13,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 60
