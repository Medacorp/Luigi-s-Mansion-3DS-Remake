...
execute as @e[type=!minecraft:item_frame,x=699,y=1,z=-22,dx=13,dy=8,dz=8] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 60
