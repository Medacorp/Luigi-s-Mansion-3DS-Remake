...
execute as @e[type=!minecraft:item_frame,x=653,y=119,z=-42,dx=30,dy=24,dz=80] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 53
...
function luigis_mansion_3ds_remake:room/hidden/balcony_2/ghosts
