...
execute if entity @s[x=666.0,y=120,z=-16.0,dx=4,dy=6,dz=8,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/balcony_2/search/statue_2