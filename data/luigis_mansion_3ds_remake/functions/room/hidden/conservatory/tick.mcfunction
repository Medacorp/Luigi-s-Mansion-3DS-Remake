...
execute as @e[type=!minecraft:item_frame,x=652,y=10,z=-29,dx=12,dy=8,dz=28] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 25
