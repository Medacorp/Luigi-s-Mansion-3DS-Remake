...
execute if entity @s[x=658.0,y=11,z=-4.0,dx=0,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/conservatory/search/saxophone