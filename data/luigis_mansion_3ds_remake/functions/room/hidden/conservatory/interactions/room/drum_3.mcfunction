...
execute if score #temp Searching matches 1 positioned 656 11 -17 run function luigis_mansion:blocks/shake/drum
scoreboard players reset #temp Searching
execute if score #conservatory_drum_3 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/conservatory/search_drum_3