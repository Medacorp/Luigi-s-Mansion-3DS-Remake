...
execute if score #temp Searching matches 1 positioned 657 11 -15 run function luigis_mansion:blocks/shake/drum
scoreboard players reset #temp Searching
execute if score #conservatory_drum_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/conservatory/search_drum_2