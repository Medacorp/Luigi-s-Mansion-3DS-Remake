execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.king_boo{health:0} unless entity @s[scores={MusicGroup=0,MusicType=18}] unless entity @s[scores={MusicGroup=0,MusicType=35}] unless entity @s[scores={MusicGroup=0,MusicType=-1}] run function luigis_mansion:other/music/set/king_boo_battle
