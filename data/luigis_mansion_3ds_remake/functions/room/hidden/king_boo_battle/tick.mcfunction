...
execute as @e[type=!minecraft:item_frame,x=465,y=25,z=-40,dx=49,dy=56,dz=85] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 76
