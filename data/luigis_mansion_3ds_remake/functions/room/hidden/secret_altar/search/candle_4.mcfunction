...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 646 94 -24 run function luigis_mansion_3ds_remake:room/hidden/secret_altar/candle_4
