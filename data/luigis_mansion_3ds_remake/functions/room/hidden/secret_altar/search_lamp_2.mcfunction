...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 648 97 -18 run function luigis_mansion_3ds_remake:room/hidden/secret_altar/lamp_2
