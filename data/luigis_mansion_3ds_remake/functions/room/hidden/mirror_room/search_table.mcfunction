...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 741 12 -61 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=740.5,y=11,z=-60.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
