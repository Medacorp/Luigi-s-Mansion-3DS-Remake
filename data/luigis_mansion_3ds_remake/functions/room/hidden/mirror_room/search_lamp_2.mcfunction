...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 741 14 -57 run function luigis_mansion:spawn_entities/item/poison_mushroom
