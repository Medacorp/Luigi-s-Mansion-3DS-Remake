execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{mirror_room_speedy_spirit:1b} positioned 740 11 -61 run function luigis_mansion:spawn_entities/ghost/speedy_spirit
