...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.mirror_room{cleared:1b} if entity @a[tag=!blackout] unless score #mirror_room Wave matches 1.. run function luigis_mansion_3ds_remake:room/hidden/mirror_room/wave_1
