...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 683 12 88 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=683.5,y=11,z=88.5,distance=..0.7,tag=hidden_boo] add spawn
