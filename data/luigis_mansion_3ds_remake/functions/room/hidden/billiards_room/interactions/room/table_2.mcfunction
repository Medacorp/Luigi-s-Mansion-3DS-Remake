...
execute if score #billiards_room_table_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/billiards_room/search/table_2
...
execute unless block 683 11 88 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/billiards_room/search/table_2