...
execute if score #billiards_room_darting_board Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/billiards_room/search_darting_board