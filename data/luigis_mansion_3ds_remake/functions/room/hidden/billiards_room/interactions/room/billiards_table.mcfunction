...
execute if score #billiards_room_billiards_table Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/billiards_room/search/billiards_table
