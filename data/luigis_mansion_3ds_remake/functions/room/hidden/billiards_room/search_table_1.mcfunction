...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 679 12 88 run function luigis_mansion:spawn_entities/item/poison_mushroom
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 679 12 88 run function luigis_mansion_3ds_remake:room/hidden/billiards_room/table_1
...
data merge block 679 11 88 {LootTable:"luigis_mansion:search"}
tag @e[x=679.5,y=11,z=88.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
