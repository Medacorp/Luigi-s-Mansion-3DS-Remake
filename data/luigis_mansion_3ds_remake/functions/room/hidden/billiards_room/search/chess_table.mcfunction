...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 685 12 67 run function luigis_mansion:spawn_entities/item/room_search/poison_mushroom
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 663 11 67 run function luigis_mansion:blocks/dust_no_sound
