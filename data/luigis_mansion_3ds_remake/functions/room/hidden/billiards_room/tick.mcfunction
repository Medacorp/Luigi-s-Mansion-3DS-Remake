...
execute as @e[type=!minecraft:item_frame,x=673,y=10,z=64,dx=15,dy=8,dz=27] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 47
...
function luigis_mansion_3ds_remake:room/hidden/billiards_room/ghosts
