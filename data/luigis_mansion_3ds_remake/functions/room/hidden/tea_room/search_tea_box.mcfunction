...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 643 22 -52 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=643.5,y=21,z=-51.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
