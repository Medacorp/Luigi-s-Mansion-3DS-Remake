...
execute as @e[type=!minecraft:item_frame,x=637,y=19,z=-62,dx=12,dy=8,dz=33] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 34
...
function luigis_mansion_3ds_remake:room/hidden/tea_room/ghosts
