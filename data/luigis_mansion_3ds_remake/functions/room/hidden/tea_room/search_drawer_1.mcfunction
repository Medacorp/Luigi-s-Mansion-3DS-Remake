...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 643 20 -32 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=643.5,y=20,z=-30.5,distance=..0.7,tag=hidden_boo] add spawn
