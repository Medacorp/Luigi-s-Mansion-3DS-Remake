...
execute if entity @s[x=643.5,y=21,z=-47.5,distance=..0.7,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/tea_room/search/ice_bucket