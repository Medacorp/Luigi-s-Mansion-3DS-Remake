...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 646 104 15 run function luigis_mansion_3ds_remake:room/hidden/courtyard/plant_1
