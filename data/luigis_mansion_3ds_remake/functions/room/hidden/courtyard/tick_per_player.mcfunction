...
execute if data storage luigis_mansion:data current_state.current_data.rooms.courtyard{seen:0b} run function luigis_mansion_3ds_remake:room/hidden/courtyard/set_seen
