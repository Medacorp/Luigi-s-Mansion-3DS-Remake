...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 647 104 -12 run function luigis_mansion_3ds_remake:room/hidden/courtyard/bird_house
