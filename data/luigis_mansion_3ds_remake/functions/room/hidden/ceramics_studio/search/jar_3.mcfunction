...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 702 29 70 run function luigis_mansion:spawn_entities/item/room_search/poison_mushroom
