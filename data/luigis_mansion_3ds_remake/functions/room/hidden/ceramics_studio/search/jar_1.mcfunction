...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 704 29 73 run function luigis_mansion:spawn_entities/item/room_search/poison_mushroom
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 704 29 73 run function luigis_mansion_3ds_remake:room/hidden/ceramics_studio/jar_1
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 703 29 73 run function luigis_mansion:blocks/dust
...
tag @e[x=703.5,y=29,z=73.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
tag @e[x=703.5,y=29,z=73.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn