...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 702 29 67 run function luigis_mansion_3ds_remake:room/hidden/ceramics_studio/jar_5
...
tag @e[x=701.5,y=29,z=67.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn