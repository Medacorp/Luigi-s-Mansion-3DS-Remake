...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 710 29 67 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=711.5,y=29,z=67.5,distance=..0.7,tag=hidden_boo] add spawn