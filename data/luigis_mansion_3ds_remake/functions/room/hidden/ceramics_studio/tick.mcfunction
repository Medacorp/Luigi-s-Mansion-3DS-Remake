...
execute as @e[type=!minecraft:item_frame,x=696,y=28,z=56,dx=17,dy=8,dz=25] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 65
