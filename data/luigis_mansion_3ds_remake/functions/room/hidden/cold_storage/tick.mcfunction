...
execute as @e[type=!minecraft:item_frame,x=721,y=1,z=-6,dx=21,dy=8,dz=18] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 68
...
function luigis_mansion_3ds_remake:room/hidden/cold_storage/ghosts
