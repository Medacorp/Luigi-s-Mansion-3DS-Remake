...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 639 12.5 -42.0 run function luigis_mansion_3ds_remake:room/hidden/rec_room/table
