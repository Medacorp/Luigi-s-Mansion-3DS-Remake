...
execute as @a[scores={Room=39},gamemode=!spectator] run function luigis_mansion:other/music/set/room
stopsound @a[scores={Room=39},gamemode=!spectator] music
playsound luigis_mansion:music.mini_game_failure music @a[scores={Room=39},gamemode=!spectator] ~ ~ ~ 1000
