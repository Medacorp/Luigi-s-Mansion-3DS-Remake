...
execute unless score #twins_room_table_1 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #twins_room_table_1 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #twins_room_table_1 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","poison_mushroom"],Duration:1}
...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 738 21 48.0 run function luigis_mansion_3ds_remake:room/hidden/twins_room/table_1
...
tag @e[x=738.5,y=20,z=48.5,distance=..0.7,tag=hidden_boo] add spawn
