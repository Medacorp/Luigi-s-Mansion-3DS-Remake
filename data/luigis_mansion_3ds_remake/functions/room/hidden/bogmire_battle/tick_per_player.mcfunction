execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.bogmire{health:0} unless entity @s[scores={MusicGroup=0,MusicType=16}] unless entity @s[scores={MusicGroup=0,MusicType=33}] unless entity @s[scores={MusicGroup=0,MusicType=-1}] run function luigis_mansion:other/music/set/bogmire_battle_skip_intro
