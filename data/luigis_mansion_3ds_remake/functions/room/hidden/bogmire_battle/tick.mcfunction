...
execute as @e[type=!minecraft:item_frame,x=777,y=5,z=-26,dx=51,dy=37,dz=55] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 74
