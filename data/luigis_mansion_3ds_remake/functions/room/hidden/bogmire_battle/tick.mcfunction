...
execute as @e[type=!minecraft:item_frame,x=777,y=5,z=-26,dx=51,dy=37,dz=55] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 74
...
execute if score #bogmire_battle ReturnTimer matches 100.. run function luigis_mansion_3ds_remake:room/hidden/bogmire_battle/clear_graveyard
