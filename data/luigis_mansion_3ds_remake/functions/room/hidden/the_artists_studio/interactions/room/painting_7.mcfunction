...
execute if score #the_artists_studio_painting_7 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/the_artists_studio/search/painting_7