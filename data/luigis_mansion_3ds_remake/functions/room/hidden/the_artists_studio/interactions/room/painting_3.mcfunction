...
execute if score #the_artists_studio_painting_3 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/the_artists_studio/search/painting_3
scoreboard players operation #temp Searching = #the_artists_studio_painting_3 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 689 29 -63 run function luigis_mansion:blocks/search_sound/generic
