...
execute if score #the_artists_studio_painting_6 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/the_artists_studio/search/painting_6
scoreboard players operation #temp Searching = #the_artists_studio_painting_6 Searching
scoreboard players operation #temp Searching %= #3 Constants
execute if score #temp Searching matches 1 positioned 692 29 -68 run function luigis_mansion:blocks/search_sound/generic
