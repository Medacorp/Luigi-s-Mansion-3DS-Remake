...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 754.0 30 4 run function luigis_mansion_3ds_remake:room/hidden/telephone_room/chest_3
...
tag @e[x=753.5,y=29,z=4.5,distance=..0.7,tag=ghost,tag=hidden] add spawn
tag @e[x=753.5,y=29,z=4.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn