...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 744 33 26 run function luigis_mansion_3ds_remake:room/hidden/telephone_room/lamp_1
