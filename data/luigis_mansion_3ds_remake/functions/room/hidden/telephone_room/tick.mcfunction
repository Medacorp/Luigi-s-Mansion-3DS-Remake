...
execute as @e[type=!minecraft:item_frame,x=736,y=28,z=0,dx=24,dy=8,dz=35] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 56
