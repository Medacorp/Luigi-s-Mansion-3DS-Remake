...
execute as @e[type=!minecraft:item_frame,x=736,y=28,z=0,dx=24,dy=8,dz=35] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 56
