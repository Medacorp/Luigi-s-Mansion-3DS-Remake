...
execute if score #safari_room_table Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/safari_room/search/table
...
execute unless block 743 30 -56 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/safari_room/search/table