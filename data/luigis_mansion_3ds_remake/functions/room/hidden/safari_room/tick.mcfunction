...
execute as @e[type=!minecraft:item_frame,x=732,y=28,z=-59,dx=14,dy=8,dz=25] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 50
