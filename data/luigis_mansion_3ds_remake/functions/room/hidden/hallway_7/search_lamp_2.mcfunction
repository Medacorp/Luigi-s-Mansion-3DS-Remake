...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 716 13 -56 run function luigis_mansion:spawn_entities/item/poison_mushroom
