...
execute as @e[type=!minecraft:item_frame,x=712,y=1,z=-63,dx=8,dy=17,dz=21] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 15
...
function luigis_mansion_3ds_remake:room/hidden/hallway_7/ghosts
