...
execute as @e[type=!minecraft:item_frame,x=712,y=1,z=-63,dx=8,dy=17,dz=21] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 15
