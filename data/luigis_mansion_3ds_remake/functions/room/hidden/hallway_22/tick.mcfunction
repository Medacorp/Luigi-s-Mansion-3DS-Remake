...
execute as @e[type=!minecraft:item_frame,x=653,y=1,z=-24,dx=33,dy=8,dz=12] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 61
