...
execute as @e[type=!minecraft:item_frame,x=653,y=1,z=-24,dx=33,dy=8,dz=12] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 61
