...
execute as @e[type=!minecraft:item_frame,x=782,y=6,z=43,dx=41,dy=33,dz=41] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 73
