...
execute as @e[type=!minecraft:item_frame,x=782,y=6,z=43,dx=41,dy=33,dz=41] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 73
...
execute if score #chauncey_battle ReturnTimer matches 100.. run function luigis_mansion_3ds_remake:room/hidden/chauncey_battle/clear_nursery
...
function luigis_mansion_3ds_remake:room/hidden/chauncey_battle/ghosts