execute unless data storage luigis_mansion:data current_state.current_data.portrait_ghosts.chauncey{health:0} unless entity @s[scores={MusicGroup=0,MusicType=15}] unless entity @s[scores={MusicGroup=0,MusicType=32}] unless entity @s[scores={MusicGroup=0,MusicType=-1}] run function luigis_mansion:other/music/set/chauncey_battle_skip_intro
