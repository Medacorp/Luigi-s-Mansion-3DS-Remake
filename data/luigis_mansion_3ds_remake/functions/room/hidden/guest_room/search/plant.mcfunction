...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 737 23 -59 run function luigis_mansion_3ds_remake:room/hidden/guest_room/plant
