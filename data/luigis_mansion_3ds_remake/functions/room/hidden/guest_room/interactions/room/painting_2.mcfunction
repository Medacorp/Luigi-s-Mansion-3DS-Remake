...
execute unless block 742 21 -52 minecraft:redstone_lamp if score #guest_room_painting_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/guest_room/search/painting_2
