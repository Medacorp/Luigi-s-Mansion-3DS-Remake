...
execute unless block 742 21 -52 minecraft:redstone_lamp if score #guest_room_painting_5 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/guest_room/search/painting_5
...
execute unless score #temp Searching matches 1 if block 742 21 -52 minecraft:redstone_lamp positioned 746 23 -59.0 run function luigis_mansion:blocks/search_sound/generic
