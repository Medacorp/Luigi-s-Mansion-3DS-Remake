...
execute unless block 742 21 -52 minecraft:redstone_lamp if score #guest_room_table_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/guest_room/search/boo_check/table_2
execute unless block 742 21 -52 minecraft:redstone_lamp unless block 744 20 -61 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/guest_room/search/boo_check/table_2
...
execute unless score #temp Searching matches 1 if block 742 21 -52 minecraft:redstone_lamp positioned 744 20 -61 run function luigis_mansion:blocks/search_sound/wood
