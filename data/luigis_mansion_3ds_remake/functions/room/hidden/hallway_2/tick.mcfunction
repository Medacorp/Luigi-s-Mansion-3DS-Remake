...
execute as @e[type=!minecraft:item_frame,x=722,y=19,z=42,dx=8,dy=8,dz=38] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 7
