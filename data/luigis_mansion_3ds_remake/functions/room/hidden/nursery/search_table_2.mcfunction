...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 739 21 56.0 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=739.5,y=20,z=55.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
