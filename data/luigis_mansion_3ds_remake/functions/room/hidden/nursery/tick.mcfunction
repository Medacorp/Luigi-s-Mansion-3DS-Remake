...
execute as @e[type=!minecraft:item_frame,x=737,y=19,z=53,dx=14,dy=8,dz=20] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 10
