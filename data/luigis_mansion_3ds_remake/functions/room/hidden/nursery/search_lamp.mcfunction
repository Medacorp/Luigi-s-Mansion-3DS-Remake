...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 744 25 63 run function luigis_mansion_3ds_remake:room/hidden/nursery/lamp
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 744 24 63 run function luigis_mansion:blocks/dust
