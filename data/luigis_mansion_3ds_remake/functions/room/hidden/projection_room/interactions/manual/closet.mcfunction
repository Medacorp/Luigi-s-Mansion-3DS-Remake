...
execute if entity @s[x=682.0,y=11,z=32.0,dx=3,dy=4,dz=1,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/projection_room/search/closet