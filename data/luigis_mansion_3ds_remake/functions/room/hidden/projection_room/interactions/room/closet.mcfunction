...
execute unless block 684 11 32 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/projection_room/search/boo_check/closet
execute unless block 683 11 32 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/projection_room/search/boo_check/closet