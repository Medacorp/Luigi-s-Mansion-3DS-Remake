...
execute as @e[type=!minecraft:item_frame,x=673,y=10,z=30,dx=15,dy=8,dz=16] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 48
