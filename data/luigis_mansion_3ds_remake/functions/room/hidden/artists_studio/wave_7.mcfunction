...
execute positioned 694 29 -68 run function luigis_mansion:spawn_entities/ghost/garbage_can_ghost
execute positioned 695 29 -70 run function luigis_mansion:spawn_entities/ghost/garbage_can_ghost
