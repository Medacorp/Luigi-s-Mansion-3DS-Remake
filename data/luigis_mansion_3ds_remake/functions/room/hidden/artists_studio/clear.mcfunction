function luigis_mansion_3ds_remake:room/hidden/artists_studio/turn_on_lights
...
function luigis_mansion_3ds_remake:room/hidden/artists_studio/remove_blockade
