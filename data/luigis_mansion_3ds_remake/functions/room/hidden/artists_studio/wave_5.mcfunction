...
execute positioned 694 29 -64 run function luigis_mansion:spawn_entities/ghost/red_grabbing_ghost
execute positioned 694 29 -66 run function luigis_mansion:spawn_entities/ghost/red_grabbing_ghost
scoreboard players set #artists_studio Wave 5