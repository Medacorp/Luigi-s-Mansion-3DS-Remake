...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 664 12 44 run function luigis_mansion_3ds_remake:room/hidden/washroom_1/toilet
...
tag @e[x=664.5,y=11,z=44.5,distance=..0.7,tag=hidden_boo] add spawn
