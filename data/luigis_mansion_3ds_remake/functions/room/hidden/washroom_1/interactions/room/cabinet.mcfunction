...
execute unless block 662 14 36 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/washroom_1/search/boo_check/cabinet
execute unless block 662 14 37 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/washroom_1/search/boo_check/cabinet