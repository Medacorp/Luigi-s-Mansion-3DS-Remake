...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 664 15 41 run function luigis_mansion:spawn_entities/item/poison_mushroom
