...
execute as @e[type=!minecraft:item_frame,x=660,y=10,z=34,dx=8,dy=8,dz=14] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 19
