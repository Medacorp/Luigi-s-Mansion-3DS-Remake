...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 651 21 18 run function luigis_mansion:spawn_entities/item/room_search/poison_mushroom
...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 648.0 21 18 run function luigis_mansion:blocks/dust_no_sound
