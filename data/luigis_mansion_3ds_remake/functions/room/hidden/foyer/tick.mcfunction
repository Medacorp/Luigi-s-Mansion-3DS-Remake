...
execute as @e[type=!minecraft:item_frame,x=743,y=10,z=-2,dx=15,dy=17,dz=21] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 1
