...
execute if score #foyer_mirror Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/foyer/search/mirror_vacuum
scoreboard players operation #temp Searching = #mirror Searching
