...
execute if score #foyer_candle_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/foyer/search/candle_2
scoreboard players operation #temp Searching = #candle_2 Searching
