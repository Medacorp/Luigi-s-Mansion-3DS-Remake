...
execute if score #foyer_table Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/foyer/search/table
...
execute unless block 746 11 13 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/foyer/search/table