...
execute if score #foyer_candle_3 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/foyer/search/candle_3
scoreboard players operation #temp Searching = #candle_3 Searching
