...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 714 12 61 run function luigis_mansion_3ds_remake:room/hidden/laundry_room/bucket
...
tag @e[x=714.5,y=11,z=61.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
