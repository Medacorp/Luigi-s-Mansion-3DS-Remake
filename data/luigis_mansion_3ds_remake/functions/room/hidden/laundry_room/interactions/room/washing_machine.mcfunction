...
execute if score #laundry_room_washing_machine Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/laundry_room/search/boo_check/washing_machine
...
execute unless block 714 12 73 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/laundry_room/search/boo_check/washing_machine