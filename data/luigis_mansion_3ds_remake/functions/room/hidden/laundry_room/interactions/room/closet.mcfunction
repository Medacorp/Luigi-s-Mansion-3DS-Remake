...
execute if score #laundry_room_closet Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/laundry_room/search/boo_check/closet
...
execute unless block 714 11 68 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/laundry_room/search/boo_check/closet