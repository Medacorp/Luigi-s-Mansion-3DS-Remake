...
execute if score #study_bookshelf_5 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/study/search/bookshelf_5
...
execute unless block 702 21 46 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/study/search/bookshelf_5