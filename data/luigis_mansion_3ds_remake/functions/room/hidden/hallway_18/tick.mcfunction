...
execute as @e[type=!minecraft:item_frame,x=723,y=28,z=40,dx=16,dy=8,dz=8] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 54
