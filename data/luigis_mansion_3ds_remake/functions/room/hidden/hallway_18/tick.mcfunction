...
execute as @e[x=723,y=28,z=40,dx=16,dy=8,dz=8] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 54
...
execute if entity @a[gamemode=!spectator,scores={Room=54},limit=1] run function luigis_mansion_3ds_remake:room/hidden/hallway_18/ghosts
