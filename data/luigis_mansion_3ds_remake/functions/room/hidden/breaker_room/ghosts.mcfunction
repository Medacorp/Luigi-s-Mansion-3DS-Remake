...
execute if score #breaker_room Wave matches 100 if block 689 3 67 minecraft:lever[face=wall,facing=east,powered=false] run function luigis_mansion_3ds_remake:room/hidden/breaker_room/end_blackout
