...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 693 6 -52 run function luigis_mansion_3ds_remake:room/hidden/breaker_room/lamp
