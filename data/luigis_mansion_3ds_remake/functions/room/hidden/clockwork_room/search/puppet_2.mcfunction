...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 689 123 -6 run function luigis_mansion:spawn_entities/item/room_search/poison_mushroom
...
tag @e[x=688.5,y=122,z=-6.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn