...
execute as @e[type=!minecraft:item_frame,x=682,y=119,z=-10,dx=17,dy=8,dz=35] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 62
