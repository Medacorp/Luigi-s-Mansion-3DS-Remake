...
execute as @e[type=!minecraft:item_frame,x=627,y=16,z=-145,dx=24,dy=11,dz=72] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 46
