...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 741 5 -52 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=742.5,y=4,z=-51.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn