...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 741 7 -52 run function luigis_mansion_3ds_remake:room/hidden/cellar/shelf_3
