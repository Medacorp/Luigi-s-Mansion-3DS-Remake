...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 743 7 -60 run function luigis_mansion_3ds_remake:room/hidden/cellar/shelf_6
...
tag @e[x=743.5,y=6,z=-60.5,distance=..0.7,tag=hidden_boo] add spawn