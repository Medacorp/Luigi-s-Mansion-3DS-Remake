...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 752 33 64 run function luigis_mansion:spawn_entities/item/poison_mushroom
