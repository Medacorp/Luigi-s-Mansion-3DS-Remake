...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 746 30 67.0 run function luigis_mansion_3ds_remake:room/hidden/armory/chest_4
...
tag @e[x=746.5,y=29,z=67.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn