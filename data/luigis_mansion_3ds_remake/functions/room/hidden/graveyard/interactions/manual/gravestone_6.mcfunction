...
execute if entity @s[x=666.0,y=102,z=43.0,dx=1,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/graveyard/search/gravestone_6