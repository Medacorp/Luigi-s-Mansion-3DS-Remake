execute unless score #graveyard_gravestone_1 Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","poison_mushroom"],Duration:1}
...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 655.0 104.5 53.0 run function luigis_mansion:spawn_entities/item/poison_mushroom
