...
execute as @e[type=!minecraft:item_frame,x=644,y=101,z=38,dx=27,dy=8,dz=18] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 29
