...
execute as @e[type=!minecraft:item_frame,x=644,y=101,z=38,dx=27,dy=8,dz=18] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 29
