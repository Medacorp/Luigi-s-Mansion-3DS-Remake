...
execute as @e[type=!minecraft:item_frame,x=697,y=10,z=28,dx=14,dy=8,dz=30] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 26
