...
execute as @e[type=!minecraft:item_frame,x=697,y=10,z=28,dx=14,dy=8,dz=30] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 26
