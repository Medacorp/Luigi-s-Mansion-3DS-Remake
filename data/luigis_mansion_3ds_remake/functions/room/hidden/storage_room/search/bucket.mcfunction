...
execute unless entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=!nothing] positioned 679 11 -55 run function luigis_mansion:blocks/dust_no_sound
