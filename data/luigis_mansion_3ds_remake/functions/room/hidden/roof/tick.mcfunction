...
execute as @e[type=!minecraft:item_frame,x=682,y=130,z=-31,dx=31,dy=15,dz=77] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 63
