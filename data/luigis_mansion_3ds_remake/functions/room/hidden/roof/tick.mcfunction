...
execute as @e[type=!minecraft:item_frame,x=682,y=131,z=-31,dx=31,dy=15,dz=77] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 63
