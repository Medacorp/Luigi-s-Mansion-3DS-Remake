...
execute if score #nanas_room_bookshelf Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/nanas_room/search/bookshelf
...
execute unless block 654 20 -15 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/nanas_room/search/bookshelf