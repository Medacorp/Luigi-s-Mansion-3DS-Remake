...
execute if entity @s[x=660.0,y=20,z=-27.0,dx=1,dy=2,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/nanas_room/search/boo_check/closet