...
execute if score #master_bedroom_table_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/master_bedroom/search/boo_check/table_1
...
execute unless block 695 111 55 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/master_bedroom/search/boo_check/table_1