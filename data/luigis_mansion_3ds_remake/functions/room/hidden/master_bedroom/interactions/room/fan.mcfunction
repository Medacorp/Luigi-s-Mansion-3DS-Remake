...
execute if score #master_bedroom_fan Searching matches 200 run function luigis_mansion_3ds_remake:room/hidden/master_bedroom/search/fan
function luigis_mansion_3ds_remake:room/hidden/master_bedroom/turn_fan