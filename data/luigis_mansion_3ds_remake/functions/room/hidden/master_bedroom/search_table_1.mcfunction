...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 695 112 55 run function luigis_mansion_3ds_remake:room/hidden/master_bedroom/table_1
