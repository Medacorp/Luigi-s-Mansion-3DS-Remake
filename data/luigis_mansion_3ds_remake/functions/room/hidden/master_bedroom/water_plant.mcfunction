...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 687 114 54 run function luigis_mansion:room/normal/master_bedroom/plant
