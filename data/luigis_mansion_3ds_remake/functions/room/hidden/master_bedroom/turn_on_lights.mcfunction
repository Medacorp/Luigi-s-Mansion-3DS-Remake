...
function #luigis_mansion_3ds_remake:room/hidden/master_bedroom/turn_lights/on
execute if data storage luigis_mansion:data current_state.current_data{boos:[{}],technical_data:{released_boos_talk:1b}} run function luigis_mansion_3ds_remake:room/hidden/master_bedroom/load_boos
