...
execute unless score #bathroom_1_mirror Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #bathroom_1_mirror Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #bathroom_1_mirror Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","poison_mushroom"],Duration:1}
execute unless score #bathroom_1_mirror Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 651 12 18 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=651.5,y=11,z=18.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
