...
execute as @e[type=!minecraft:item_frame,x=648,y=10,z=15,dx=12,dy=8,dz=14] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 16
