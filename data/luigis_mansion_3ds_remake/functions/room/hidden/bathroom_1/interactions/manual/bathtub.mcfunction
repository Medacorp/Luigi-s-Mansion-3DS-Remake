...
execute if entity @s[x=650.0,y=11,z=21.0,dx=2,dy=1,dz=5,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/bathroom_1/search/bathtub