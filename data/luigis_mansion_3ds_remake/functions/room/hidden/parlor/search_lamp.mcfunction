...
execute unless score #parlor_lamp Searched matches 1 unless entity @a[tag=meet_e_gadd,limit=1] run summon minecraft:marker ~ ~ ~ {Tags:["chance","poison_mushroom"],Duration:1}
execute unless score #parlor_lamp Searched matches 1 run summon minecraft:marker ~ ~ ~ {Tags:["chance","nothing"],Duration:1}
execute unless score #parlor_lamp Searched matches 1 unless entity @a[tag=meet_e_gadd,limit=1] run summon minecraft:marker ~ ~ ~ {Tags:["chance","poison_mushroom"],Duration:1}
execute unless score #parlor_lamp Searched matches 1 unless entity @a[tag=meet_e_gadd,limit=1] run summon minecraft:marker ~ ~ ~ {Tags:["chance","money"],Duration:1}
...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 721.0 24 28.0 run function luigis_mansion_3ds_remake:room/hidden/parlor/lamp
