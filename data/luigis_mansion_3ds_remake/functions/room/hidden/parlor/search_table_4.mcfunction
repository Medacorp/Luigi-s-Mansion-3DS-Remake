...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 727 22 19 run function luigis_mansion:spawn_entities/item/poison_mushroom
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 727 22 19 run function luigis_mansion_3ds_remake:room/hidden/parlor/table_4
...
tag @e[x=727.5,y=21,z=19.5,distance=..0.7,tag=hidden_boo] add spawn
