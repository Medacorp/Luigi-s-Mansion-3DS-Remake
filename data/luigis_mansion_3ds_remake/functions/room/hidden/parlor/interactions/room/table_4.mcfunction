...
execute if score #parlor_table_4 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/parlor/search/boo_check/table_4
...
execute unless block 727 21 19 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/parlor/search/boo_check/table_4