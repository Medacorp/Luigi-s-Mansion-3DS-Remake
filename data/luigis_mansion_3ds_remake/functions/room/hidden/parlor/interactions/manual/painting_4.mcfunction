...
execute if entity @s[x=713.0,y=21,z=27.0,dx=0,dy=1,dz=1,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/parlor/search/painting_5