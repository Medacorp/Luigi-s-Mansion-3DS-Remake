...
execute if score #butlers_room_sewing_machine Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/butlers_room/search/sewing_machine