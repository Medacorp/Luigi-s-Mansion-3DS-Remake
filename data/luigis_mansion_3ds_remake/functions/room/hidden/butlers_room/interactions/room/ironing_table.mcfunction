...
execute if score #butlers_room_ironing_table Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/butlers_room/search/ironing_table_vacuum