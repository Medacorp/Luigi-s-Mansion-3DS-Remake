...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 744 12 62 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=745.5,y=11,z=63.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
