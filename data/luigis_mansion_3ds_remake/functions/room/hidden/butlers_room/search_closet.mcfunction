...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 740 13 66 run function luigis_mansion_3ds_remake:room/hidden/butlers_room/closet
...
tag @e[x=739.5,y=11,z=66.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
