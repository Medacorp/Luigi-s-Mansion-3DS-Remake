...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 744 15 63 run function luigis_mansion_3ds_remake:room/hidden/butlers_room/lamp
