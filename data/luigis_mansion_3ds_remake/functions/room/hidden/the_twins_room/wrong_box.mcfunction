...
function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search_box_1
function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search_box_2
function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search_box_3
function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search_box_4
function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search_box_5
