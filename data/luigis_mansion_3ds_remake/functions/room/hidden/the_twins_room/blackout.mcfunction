...
execute unless data storage luigis_mansion:data current_state.current_data.money_spawned{the_twins_room_speedy_spirit:1b} positioned 739 22 34 run function luigis_mansion:spawn_entities/ghost/speedy_spirit
