...
execute unless block 738 20 47 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search/boo_check/table_1
execute unless block 738 20 48 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search/boo_check/table_1