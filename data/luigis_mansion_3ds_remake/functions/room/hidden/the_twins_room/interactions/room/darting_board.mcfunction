...
execute if score #the_twins_room_darting_board Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/search/darting_board