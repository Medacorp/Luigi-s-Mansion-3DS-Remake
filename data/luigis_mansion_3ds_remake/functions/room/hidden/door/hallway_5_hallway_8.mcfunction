...
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=682.5,y=11,z=-29.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{hallway_8:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_8:1b} positioned 682 11 -29 run function luigis_mansion_3ds_remake:room/hidden/hallway_8/unlock_door
execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=663.5,y=11,z=-36.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{hallway_8:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_8:1b} positioned 663 11 -37 run function luigis_mansion_3ds_remake:room/hidden/hallway_8/unlock_door
execute if score #main_hallway Ticking matches 1 if block 682 11 -29 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_8:1b} positioned 682 11 -29 run function luigis_mansion:blocks/closed_door
execute if score #hallway_8 Ticking matches 1 if block 663 11 -37 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_8:1b} positioned 663 11 -37 run function luigis_mansion:blocks/closed_door
execute unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_8:1b} if score #temp Searched matches 1..2 run scoreboard players set #temp Searched -1
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=13}] 682 11 -29.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=33}] 663 11 -36.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=13}] 682 11 -29.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=33}] 663 11 -36.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=11,z=-29.0,dx=0,dy=1,dz=0] run stopsound @s[scores={RoomNoise=1..}] ambient luigis_mansion:music.mansion.melody
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=11,z=-29.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=682.0,y=11,z=-29.0,dx=0,dy=1,dz=0] run teleport @s 663 11 -38
execute if score #temp Searched matches 1..2 as @a[x=663.0,y=11,z=-37.0,dx=0,dy=1,dz=0] run teleport @s 682 11 -28
