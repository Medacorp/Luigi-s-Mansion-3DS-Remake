...
execute if score #hallway_5 Ticking matches 1 if block 682 11 -29 #minecraft:doors[open=true] unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_8:1b} positioned 682 11 -29 run function luigis_mansion:blocks/closed_door
