...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=11}] 720.0 11 -28 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=20}] 735.0 11 -32 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=11}] 720.0 11 -28 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=20}] 735.0 11 -32 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=11,z=-28.0,dx=0,dy=1,dz=0] run teleport @s 736 11 -32
execute if score #temp Searched matches 1..2 as @a[x=735.0,y=11,z=-32.0,dx=0,dy=1,dz=0] run teleport @s 718 11 -28
