...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=55}] 752 29 48.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=64}] 757 29 55.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=55}] 752 29 48.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=64}] 757 29 55.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=752.0,y=29,z=47.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=752.0,y=29,z=47.0,dx=0,dy=1,dz=0] run teleport @s 757 29 56
execute if score #temp Searched matches 1..2 as @a[x=757.0,y=29,z=55.0,dx=0,dy=1,dz=0] run teleport @s 752 29 46
