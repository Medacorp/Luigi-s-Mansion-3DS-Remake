...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=13}] 686.0 11 5 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=47}] 674.0 11 70 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=13}] 686.0 11 5 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=47}] 674.0 11 70 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=685.0,y=11,z=5.0,dx=0,dy=1,dz=0] run stopsound @s[scores={RoomNoise=1..}] ambient luigis_mansion:music.mansion.melody
execute if score #temp Searched matches 1..2 as @a[x=685.0,y=11,z=5.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=685.0,y=11,z=5.0,dx=0,dy=1,dz=0] run teleport @s 675 11 70
execute if score #temp Searched matches 1..2 as @a[x=674.0,y=11,z=70.0,dx=0,dy=1,dz=0] run teleport @s 684 11 5
