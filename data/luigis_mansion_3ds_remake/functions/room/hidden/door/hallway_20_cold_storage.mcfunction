...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=59}] 726 2 -14.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=68}] 735 2 -5.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=59}] 726 2 -14.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=68}] 735 2 -5.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=726.0,y=2,z=-15.0,dx=0,dy=1,dz=0] run teleport @s 735 2 -4
execute if score #temp Searched matches 1..2 as @a[x=735.0,y=2,z=-5.0,dx=0,dy=1,dz=0] run teleport @s 726 2 -16
