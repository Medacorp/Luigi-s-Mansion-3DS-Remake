...
execute if block 743 11 8 minecraft:jungle_door[powered=false] run scoreboard players set #temp Searched -1
execute if block 743 11 9 minecraft:jungle_door[powered=false] run scoreboard players set #temp Searched -1
execute if block 719 11 -6 minecraft:jungle_door[powered=false] run scoreboard players set #temp Searched -1
execute if block 719 11 -5 minecraft:jungle_door[powered=false] run scoreboard players set #temp Searched -1

execute if score #temp Searched matches 1..2 as @a[gamemode=!spectator,distance=..3,x=743.0,y=11,z=9.0] if data storage luigis_mansion:data current_state.current_data.obtained_keys{hallway_3:1b} unless data storage luigis_mansion:data current_state.current_data.used_keys{hallway_3:1b} positioned 743 11 9.0 run function luigis_mansion_3ds_remake:room/hidden/main_hallway/unlock_door
...
execute if score #temp Searched matches 1 run setblock 743 11 8 minecraft:jungle_door[open=true,facing=west,half=lower,hinge=right,powered=true]
execute if score #temp Searched matches 1 run setblock 743 12 8 minecraft:jungle_door[open=true,facing=west,half=upper,hinge=right,powered=true]
execute if score #temp Searched matches 1 run setblock 743 11 9 minecraft:jungle_door[open=true,facing=west,half=lower,hinge=left,powered=true]
execute if score #temp Searched matches 1 run setblock 743 12 9 minecraft:jungle_door[open=true,facing=west,half=upper,hinge=left,powered=true]
execute if score #temp Searched matches 1 run setblock 719 11 -6 minecraft:jungle_door[open=true,facing=east,half=lower,hinge=left,powered=true]
execute if score #temp Searched matches 1 run setblock 719 12 -6 minecraft:jungle_door[open=true,facing=east,half=upper,hinge=left,powered=true]
execute if score #temp Searched matches 1 run setblock 719 11 -5 minecraft:jungle_door[open=true,facing=east,half=lower,hinge=right,powered=true]
execute if score #temp Searched matches 1 run setblock 719 12 -5 minecraft:jungle_door[open=true,facing=east,half=upper,hinge=right,powered=true]
...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=11}] 721.0 11 -5.0 1 1
...
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=11}] 721.0 11 -5.0 1 1
...
execute if score #temp Searched matches -1..0 run setblock 743 11 8 minecraft:jungle_door[open=false,facing=west,half=lower,hinge=right,powered=true]
execute if score #temp Searched matches -1..0 run setblock 743 12 8 minecraft:jungle_door[open=false,facing=west,half=upper,hinge=right,powered=true]
execute if score #temp Searched matches -1..0 run setblock 743 11 9 minecraft:jungle_door[open=false,facing=west,half=lower,hinge=left,powered=true]
execute if score #temp Searched matches -1..0 run setblock 743 12 9 minecraft:jungle_door[open=false,facing=west,half=upper,hinge=left,powered=true]
execute if score #temp Searched matches -1..0 run setblock 719 11 -6 minecraft:jungle_door[open=false,facing=east,half=lower,hinge=left,powered=true]
execute if score #temp Searched matches -1..0 run setblock 719 12 -6 minecraft:jungle_door[open=false,facing=east,half=upper,hinge=left,powered=true]
execute if score #temp Searched matches -1..0 run setblock 719 11 -5 minecraft:jungle_door[open=false,facing=east,half=lower,hinge=right,powered=true]
execute if score #temp Searched matches -1..0 run setblock 719 12 -5 minecraft:jungle_door[open=false,facing=east,half=upper,hinge=right,powered=true]
