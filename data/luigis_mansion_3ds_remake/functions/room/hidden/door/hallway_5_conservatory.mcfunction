...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=13}] 679.0 11 0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=25}] 664.0 11 -6 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=13}] 679.0 11 0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=25}] 664.0 11 -6 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=679.0,y=11,z=0.0,dx=0,dy=1,dz=0] run stopsound @s[scores={RoomNoise=1..}] ambient luigis_mansion:music.mansion.melody
execute if score #temp Searched matches 1..2 as @a[x=679.0,y=11,z=0.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=679.0,y=11,z=0.0,dx=0,dy=1,dz=0] run teleport @s 662 11 -6
execute if score #temp Searched matches 1..2 as @a[x=663.0,y=11,z=-6.0,dx=0,dy=1,dz=0] run scoreboard players reset @s Time
execute if score #temp Searched matches 1..2 as @a[x=663.0,y=11,z=-6.0,dx=0,dy=1,dz=0] run teleport @s 680 11 0
