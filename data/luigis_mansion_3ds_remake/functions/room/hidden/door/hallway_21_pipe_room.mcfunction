...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=60}] 706 2 -14.0 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=67}] 693 2 -5.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=60}] 706 2 -14.0 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=67}] 693 2 -5.0 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=706.0,y=2,z=-15.0,dx=0,dy=1,dz=0] run teleport @s 693 2 -4
execute if score #temp Searched matches 1..2 as @a[x=693.0,y=2,z=-5.0,dx=0,dy=1,dz=0] run teleport @s 706 2 -16
