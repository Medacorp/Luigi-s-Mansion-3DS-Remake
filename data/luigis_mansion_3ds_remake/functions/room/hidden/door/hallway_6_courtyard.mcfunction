...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=14}] 667.0 11 8 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=30}] 653.0 102 21 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=14}] 667.0 11 8 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=30}] 653.0 102 21 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=668.0,y=11,z=8.0,dx=0,dy=1,dz=0] run teleport @s 652 102 21
execute if score #temp Searched matches 1..2 as @a[x=653.0,y=102,z=21.0,dx=0,dy=1,dz=0] run scoreboard players set @s RoomNoise 0
execute if score #temp Searched matches 1..2 as @a[x=653.0,y=102,z=21.0,dx=0,dy=1,dz=0] run teleport @s 669 11 8
