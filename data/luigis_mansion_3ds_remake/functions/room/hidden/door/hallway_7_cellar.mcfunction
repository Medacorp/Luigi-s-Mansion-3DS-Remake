...
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=15}] 720.0 2 -47 1 1
execute if score #temp Searched matches 0 run playsound luigis_mansion:block.door.close block @a[scores={Room=58}] 735.0 2 -47 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=15}] 720.0 2 -47 1 1
execute if score #temp Searched matches 1 run playsound luigis_mansion:block.door.open block @a[scores={Room=58}] 735.0 2 -47 1 1
...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=2,z=-47.0,dx=0,dy=1,dz=0] run teleport @s 736 2 -47
execute if score #temp Searched matches 1..2 as @a[x=735.0,y=2,z=-47.0,dx=0,dy=1,dz=0] run teleport @s 718 2 -47
