...
execute if score #temp Searched matches 1..2 as @a[x=719.0,y=20,z=-30.0,dx=0,dy=1,dz=0] run teleport @s 736 20 -34
execute if score #temp Searched matches 1..2 as @a[x=735.0,y=20,z=-34.0,dx=0,dy=1,dz=0] run teleport @s 718 20 -30
