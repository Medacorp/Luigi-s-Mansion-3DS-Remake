...
execute as @e[type=!minecraft:item_frame,x=683,y=19,z=22,dx=12,dy=8,dz=21] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 4
