...
execute unless entity @e[x=701.5,y=11,z=70.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] run function luigis_mansion_3ds_remake:room/hidden/hidden_room/search/fridge
