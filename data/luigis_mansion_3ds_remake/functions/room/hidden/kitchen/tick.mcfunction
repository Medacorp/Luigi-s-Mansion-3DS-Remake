...
execute as @e[type=!minecraft:item_frame,x=697,y=10,z=61,dx=14,dy=8,dz=31] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 27
