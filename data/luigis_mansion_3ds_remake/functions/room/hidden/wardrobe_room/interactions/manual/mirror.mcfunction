...
execute if entity @s[x=677.0,y=20,z=60.0,dx=0,dy=4,dz=3,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/wardrobe_room/search/mirror