...
execute if entity @s[x=684.0,y=20,z=57.0,dx=2,dy=1,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/wardrobe_room/search/boo_check/show_stand