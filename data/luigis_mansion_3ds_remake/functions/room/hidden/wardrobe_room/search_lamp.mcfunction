...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 682.0 24 66.0 run function luigis_mansion:spawn_entities/item/poison_mushroom
