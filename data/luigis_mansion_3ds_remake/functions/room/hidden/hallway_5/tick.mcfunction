...
execute as @e[type=!minecraft:item_frame,x=679,y=10,z=-30,dx=6,dy=8,dz=42] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 13
