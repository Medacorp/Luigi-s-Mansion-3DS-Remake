...
execute as @e[type=!minecraft:item_frame,x=679,y=10,z=-30,dx=6,dy=8,dz=42] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 13
...
function luigis_mansion_3ds_remake:room/hidden/hallway_5/ghosts
