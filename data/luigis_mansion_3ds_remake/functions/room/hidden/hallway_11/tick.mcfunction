...
execute as @e[type=!minecraft:item_frame,x=686,y=19,z=-23,dx=10,dy=8,dz=8] unless entity @s[type=!minecraft:player,tag=!model_piece,scores={Room=-2147483648..}] run scoreboard players set @s Room 37
...
function luigis_mansion_3ds_remake:room/hidden/hallway_11/ghosts
