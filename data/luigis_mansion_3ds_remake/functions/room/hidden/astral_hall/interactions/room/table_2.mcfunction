...
execute if score #astral_hall_table_2 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/astral_hall/search/boo_check/table_2
...
execute unless block 662 20 -89 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/astral_hall/search/boo_check/table_2