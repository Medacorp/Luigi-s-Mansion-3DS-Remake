...
execute if score #astral_hall_table_1 Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/astral_hall/search/boo_check/table_1
...
execute unless block 662 20 -75 minecraft:chest{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/astral_hall/search/boo_check/table_1