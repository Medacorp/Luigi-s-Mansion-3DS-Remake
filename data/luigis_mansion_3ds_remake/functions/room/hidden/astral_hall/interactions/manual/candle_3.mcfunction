...
execute if entity @s[x=662.0,y=20,z=-82.0,dx=0,dy=2,dz=0,tag=!sound,tag=!check] run function luigis_mansion_3ds_remake:room/hidden/astral_hall/search/candle_3