...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 663 21 -89 run function luigis_mansion:spawn_entities/item/poison_mushroom
...
tag @e[x=662.5,y=20,z=-88.5,distance=..0.7,tag=hidden_boo,tag=caught_by_boo_radar] add spawn
