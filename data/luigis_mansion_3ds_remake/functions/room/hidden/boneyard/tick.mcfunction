...
execute as @e[type=!minecraft:item_frame,x=671,y=101,z=37,dx=14,dy=8,dz=19] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 28
