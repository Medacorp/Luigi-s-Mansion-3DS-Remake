...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.boneyard{cleared:1b} if entity @a[tag=!blackout] unless score #boneyard Wave matches 1.. run function luigis_mansion_3ds_remake:room/hidden/boneyard/wave_1
execute if entity @a[tag=blackout] unless score #boneyard Wave matches 1.. run function luigis_mansion_3ds_remake:room/hidden/boneyard/blackout