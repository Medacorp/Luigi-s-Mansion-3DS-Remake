...
execute if score #washroom_2_sink Searching matches 20 run function luigis_mansion_3ds_remake:room/hidden/washroom_2/search/sink
...
execute unless block 662 20 40 minecraft:dropper{LootTable:"luigis_mansion:search"} run function luigis_mansion_3ds_remake:room/hidden/washroom_2/search/sink