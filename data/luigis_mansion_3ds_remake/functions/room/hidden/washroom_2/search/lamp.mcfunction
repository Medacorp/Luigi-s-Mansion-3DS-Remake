...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 664 24 41 run function luigis_mansion_3ds_remake:room/hidden/washroom_2/lamp
