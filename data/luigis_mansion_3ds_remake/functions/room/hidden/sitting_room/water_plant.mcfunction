...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 738 23 -22 run function luigis_mansion_3ds_remake:room/hidden/sitting_room/plant
