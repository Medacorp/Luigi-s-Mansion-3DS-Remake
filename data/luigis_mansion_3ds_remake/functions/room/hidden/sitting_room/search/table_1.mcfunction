...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=poison_mushroom] positioned 746 21 -22 run function luigis_mansion:spawn_entities/item/room_search/poison_mushroom
