...
execute as @e[type=!minecraft:item_frame,x=659,y=10,z=-62,dx=8,dy=17,dz=26] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 33
