...
execute as @e[type=!minecraft:item_frame,x=713,y=19,z=-42,dx=7,dy=8,dz=27] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room 39
