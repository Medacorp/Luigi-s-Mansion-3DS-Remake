...
execute as @e[x=735,y=10,z=-2,dx=7,dy=17,dz=21] unless entity @s[x=743,y=10,z=-2,dx=15,dy=17,dz=21] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room 2
...
execute if entity @a[gamemode=!spectator,scores={Room=2}] run function luigis_mansion_3ds_remake:room/hidden/hallway_1/ghosts
