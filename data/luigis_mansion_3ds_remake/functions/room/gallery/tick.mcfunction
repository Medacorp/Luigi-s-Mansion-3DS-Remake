...
execute as @e[type=!minecraft:item_frame,x=733,y=0,z=-60,dx=43,dy=26,dz=44] unless entity @s[tag=ghost,tag=appear] unless entity @s[tag=ghost,tag=vanish] run scoreboard players set @s Room -4
