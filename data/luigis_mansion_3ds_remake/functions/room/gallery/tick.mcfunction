...
execute as @e[type=!minecraft:item_frame,x=733,y=0,z=-60,dx=43,dy=26,dz=44] unless entity @s[type=!minecraft:player,scores={Room=-2147483648..}] run scoreboard players set @s Room -4
