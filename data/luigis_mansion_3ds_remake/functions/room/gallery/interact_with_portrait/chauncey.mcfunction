...
execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{chauncey:3b}} run data merge entity @e[x=765.5,y=4,z=-21.5,type=minecraft:item_frame,distance=..0.7,limit=1] {Item:{id:"minecraft:filled_map",Count:1b,tag:{map:11}}}
