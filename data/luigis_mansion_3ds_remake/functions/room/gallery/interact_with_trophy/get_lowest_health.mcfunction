execute store result score #temp2 ActionTime run data get storage luigis_mansion:data high_scores[0].health
execute if score #temp2 ActionTime >= #temp ActionTime run scoreboard players set #temp Time 1
