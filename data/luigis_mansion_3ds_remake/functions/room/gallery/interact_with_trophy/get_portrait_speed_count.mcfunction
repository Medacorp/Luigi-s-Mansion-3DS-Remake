...
function luigis_mansion_3ds_remake:room/gallery/interact_with_trophy/get_lowest_time
...
function luigis_mansion_3ds_remake:room/gallery/interact_with_trophy/get_lowest_time
execute if score #temp2 Money > #temp Money run scoreboard players set #temp Time -1
data remove storage luigis_mansion_3ds_remake:data currently_checked
