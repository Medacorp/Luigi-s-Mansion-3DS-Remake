...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=key] positioned 736 2 -23.0 run function luigis_mansion_3ds_remake:room/gallery/chest
