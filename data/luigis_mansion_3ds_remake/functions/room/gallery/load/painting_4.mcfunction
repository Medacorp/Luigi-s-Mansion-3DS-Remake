execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{clockwork_soldiers:-1b}} run data modify storage luigis_mansion_3ds_remake:data current_state.selected_portraits.clockwork_soldiers set from storage luigis_mansion:data current_state.portrait_ghost_ranks.clockwork_soldiers
...
execute positioned 745 18 -24 run tag @e[distance=..0.7,tag=gallery_check] add clockwork_soldiers_painting