execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{floating_whirlindas:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.floating_whirlindas set from storage luigis_mansion:data portrait_ghost_ranks.floating_whirlindas
