execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{melody_pianissima:-1b}} run data modify storage luigis_mansion_3ds_remake:data current_state.selected_portraits.melody_pianissima set from storage luigis_mansion:data current_state.portrait_ghost_ranks.melody_pianissima
...
execute positioned 757 8 -31 run tag @e[distance=..0.7,tag=gallery_check] add melody_pianissima_painting