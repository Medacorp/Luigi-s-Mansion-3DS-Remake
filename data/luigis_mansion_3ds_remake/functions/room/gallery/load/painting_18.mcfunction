execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{vincent_van_gore:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.vincent_van_gore set from storage luigis_mansion:data portrait_ghost_ranks.vincent_van_gore
...
execute positioned 745 18 -33 run tag @e[distance=..0.7,tag=gallery_check] add 18