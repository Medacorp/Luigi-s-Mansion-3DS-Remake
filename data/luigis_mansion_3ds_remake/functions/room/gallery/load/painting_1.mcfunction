execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{biff_atlas:-1b}} run data modify storage luigis_mansion_3ds_remake:data current_state.selected_portraits.biff_atlas set from storage luigis_mansion:data current_state.portrait_ghost_ranks.biff_atlas
