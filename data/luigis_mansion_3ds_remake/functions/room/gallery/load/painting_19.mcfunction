execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{madame_clairvoya:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.madame_clairvoya set from storage luigis_mansion:data portrait_ghost_ranks.madame_clairvoya
