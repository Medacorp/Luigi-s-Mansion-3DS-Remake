execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{spooky:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.spooky set from storage luigis_mansion:data portrait_ghost_ranks.spooky
