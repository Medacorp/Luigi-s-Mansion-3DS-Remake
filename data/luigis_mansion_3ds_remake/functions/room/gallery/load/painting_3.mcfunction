execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{chauncey:-1b}} run data modify storage luigis_mansion_3ds_remake:data current_state.selected_portraits.chauncey set from storage luigis_mansion:data current_state.portrait_ghost_ranks.chauncey
