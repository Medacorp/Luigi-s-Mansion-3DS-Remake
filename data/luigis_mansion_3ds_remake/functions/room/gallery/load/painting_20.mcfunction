execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{mr_luggs:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.mr_luggs set from storage luigis_mansion:data portrait_ghost_ranks.mr_luggs
