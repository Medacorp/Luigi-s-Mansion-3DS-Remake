execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{uncle_grimmly:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.uncle_grimmly set from storage luigis_mansion:data portrait_ghost_ranks.uncle_grimmly
