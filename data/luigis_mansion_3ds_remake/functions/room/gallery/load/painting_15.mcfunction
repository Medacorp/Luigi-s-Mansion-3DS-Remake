execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{sir_weston:-1b}} run data modify storage luigis_mansion_3ds_remake:data current_state.selected_portraits.sir_weston set from storage luigis_mansion:data current_state.portrait_ghost_ranks.sir_weston
