execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{shivers:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.shivers set from storage luigis_mansion:data portrait_ghost_ranks.shivers
