execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{nana:-1b}} run data modify storage luigis_mansion_3ds_remake:data current_state.selected_portraits.nana set from storage luigis_mansion:data current_state.portrait_ghost_ranks.nana
