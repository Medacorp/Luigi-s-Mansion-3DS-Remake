execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{henry_and_orville:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.henry_and_orville set from storage luigis_mansion:data portrait_ghost_ranks.henry_and_orville
