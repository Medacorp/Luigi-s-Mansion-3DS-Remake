execute if data storage luigis_mansion_3ds_remake:data {selected_portraits:{miss_petunia:-1b}} run data modify storage luigis_mansion_3ds_remake:data selected_portraits.miss_petunia set from storage luigis_mansion:data portrait_ghost_ranks.miss_petunia
