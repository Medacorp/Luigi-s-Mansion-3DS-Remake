...
execute if entity @e[tag=orville,tag=dialog,scores={Dialog=333}] run function luigis_mansion:room/normal/the_twins_room/wave_5
execute if score #the_twins_room_mobile Searching matches 1.. run function luigis_mansion:room/normal/the_twins_room/search_mobile