...
tag @e[tag=door,tag=!blockade,type=minecraft:villager,scores={Room=1..}] remove can_play_blockade_sound
tag @e[tag=door,tag=!blockade,type=minecraft:villager,scores={Room=1..}] add blockade