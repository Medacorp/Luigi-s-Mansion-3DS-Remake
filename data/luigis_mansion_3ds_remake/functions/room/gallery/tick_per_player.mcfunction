execute unless entity @s[scores={MusicGroup=0,MusicType=4}] unless entity @s[scores={MusicGroup=0,MusicType=-1}] run function luigis_mansion:other/music/set/gallery
