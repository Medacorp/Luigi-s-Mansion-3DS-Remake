execute store result score #temp Time run data get entity @s[nbt={ArmorItems:[{id:"minecraft:diamond_pickaxe"}]}] ArmorItems[3].tag.CustomModelData
...
execute store result score #temp Time run data get entity @s[nbt={HandItems:[{id:"minecraft:diamond_pickaxe"}]}] HandItems[0].tag.CustomModelData
...
execute store result score #temp Time run data get entity @s[nbt={HandItems:[{id:"minecraft:diamond_pickaxe"}]}] HandItems[1].tag.CustomModelData
