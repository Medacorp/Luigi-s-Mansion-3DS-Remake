...
execute if entity @s[scores={DeathTime=1,Shrunk=0}] run playsound luigis_mansion_3ds_remake:entity.gooigi.spawn player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={DeathTime=1,Shrunk=1..}] run playsound luigis_mansion_3ds_remake:entity.gooigi.spawn player @a[tag=same_room] ~ ~ ~ 1 2
