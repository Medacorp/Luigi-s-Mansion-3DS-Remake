...
execute if entity @s[scores={IdleTime=20..,Health=16..},tag=cold_room,tag=!cold_room_idle,tag=!high_health_idle,tag=!low_health_idle] run function luigis_mansion:entities/player/animation/cold_room_idle
execute if entity @s[scores={IdleTime=20..,Health=16..},tag=cold_room_idle,tag=!high_health_idle,tag=!low_health_idle] run function luigis_mansion:entities/player/animation/cold_room_idle
