...
execute if entity @s[tag=left_leg,tag=!death_animation,tag=!spawn_animation] run function luigis_mansion_3ds_remake:animations/gooigi/left_leg
execute if entity @s[tag=right_leg,tag=!death_animation,tag=!spawn_animation] run function luigis_mansion_3ds_remake:animations/gooigi/right_leg
execute if entity @s[tag=left_arm,tag=!death_animation,tag=!spawn_animation] run function luigis_mansion_3ds_remake:animations/gooigi/left_arm
...
execute if entity @s[tag=left_arm,tag=spawn_animation] run function luigis_mansion_3ds_remake:animations/gooigi/spawn/left_arm
