...
execute if entity @s[tag=!looking_at_map,scores={KnockbackType=0}] run function luigis_mansion_3ds_remake:animations/gooigi/idle/right_arm
...
execute if entity @s[tag=sneaking,tag=!looking_at_map] run function luigis_mansion_3ds_remake:animations/gooigi/sneaking/right_arm
execute if entity @s[tag=walking,tag=!looking_at_map] run function luigis_mansion_3ds_remake:animations/gooigi/walking/right_arm
execute if entity @s[tag=running,tag=!looking_at_map] run function luigis_mansion_3ds_remake:animations/gooigi/running/right_arm
...
execute at @s[tag=!held_item,scores={KnockbackType=1}] run function luigis_mansion_3ds_remake:animations/gooigi/knockback/small/right_arm
execute at @s[tag=!held_item,scores={KnockbackType=2}] run function luigis_mansion_3ds_remake:animations/gooigi/knockback/medium/right_arm
execute at @s[tag=!held_item,scores={KnockbackType=3}] run function luigis_mansion_3ds_remake:animations/gooigi/knockback/large/right_arm
execute at @s[tag=!held_item,scores={KnockbackType=4}] run function luigis_mansion_3ds_remake:animations/gooigi/knockback/burn/right_arm
execute at @s[tag=!held_item,scores={KnockbackType=5}] run function luigis_mansion_3ds_remake:animations/gooigi/knockback/soak/right_arm
execute at @s[tag=!held_item,scores={KnockbackType=6}] run function luigis_mansion_3ds_remake:animations/gooigi/knockback/freeze/right_arm