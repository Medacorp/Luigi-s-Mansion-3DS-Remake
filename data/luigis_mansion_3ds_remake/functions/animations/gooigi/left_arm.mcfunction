...
execute if score #mirrored Selected matches 1 if entity @s[tag=attacking,tag=!stop_model,tag=!holding_poltergust] run function luigis_mansion_3ds_remake:animations/gooigi/attack/left_arm
...
execute if entity @s[tag=!stop_model,tag=!cold_room_idle,tag=!high_health_idle,tag=!low_health_idle,scores={KnockbackType=0,Pull=0..9}] unless entity @s[tag=low_health,tag=!holding_poltergust] run function luigis_mansion_3ds_remake:animations/gooigi/idle/left_arm
execute if entity @s[tag=!stop_model,tag=!cold_room_idle,tag=!high_health_idle,tag=!low_health_idle,scores={KnockbackType=0,Pull=0..9}] if entity @s[tag=low_health,tag=!holding_poltergust] run function luigis_mansion_3ds_remake:animations/gooigi/idle/hunched/left_arm
...
execute at @s[scores={KnockbackType=-9}] unless entity @s[tag=held_item,tag=holding_poltergust] run function luigis_mansion_3ds_remake:animations/gooigi/search/small_chest/left_arm
