...
function luigis_mansion_3ds_remake:animations/gooigi/idle/left_arm
...
execute if entity @s[tag=sneaking] run function luigis_mansion_3ds_remake:animations/gooigi/sneaking/left_arm
execute if entity @s[tag=walking] run function luigis_mansion_3ds_remake:animations/gooigi/walking/left_arm
execute if entity @s[tag=running] run function luigis_mansion_3ds_remake:animations/gooigi/running/left_arm
execute if entity @s[tag=swimming] run function luigis_mansion_3ds_remake:animations/gooigi/swimming/left_arm