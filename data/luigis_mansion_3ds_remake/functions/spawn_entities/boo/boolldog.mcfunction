...
execute if data storage luigis_mansion:data current_state.current_data.boos[{name:"boolldog",loot_at_0:1b}] run tag @e[tag=this_entity,limit=1] add loot_at_0
