summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_mansion_3ds_remake:item.gameboy_horror_part"}',Pose:{Head:[0.0f,0.0f,0.01f]},Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:31}}],Tags:["item","gameboy_horror_part","vacuumable","eternal","this_entity"],DisabledSlots:2039583}
...
playsound luigis_mansion_3ds_remake:item.gameboy_horror_part.spawn player @a ~ ~ ~ 1