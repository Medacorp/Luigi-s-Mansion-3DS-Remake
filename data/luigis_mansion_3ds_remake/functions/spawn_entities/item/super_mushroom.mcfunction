summon minecraft:armor_stand ~ ~-1 ~ {CustomName:'{"translate":"luigis_mansion_3ds_remake:item.super_mushroom"}',Pose:{Head:[0.0f,0.0f,0.01f]},Marker:1b,Invisible:1b,Silent:1b,ArmorItems:[{},{},{},{id:"minecraft:diamond_pickaxe",Count:1b,tag:{Unbreakable:1b,Damage:5,CustomModelData:30}}],Tags:["item","super_mushroom","this_entity"],DisabledSlots:2039583}
...
playsound luigis_mansion_3ds_remake:item.super_mushroom.spawn player @a ~ ~ ~ 1