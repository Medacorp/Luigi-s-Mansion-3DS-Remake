...
execute unless entity @a[advancements={luigis_mansion_3ds_remake:lab/s_rank=true}] if data storage luigis_mansion:data high_scores[0] run function luigis_mansion_3ds_remake:other/load_data/get_high_score
