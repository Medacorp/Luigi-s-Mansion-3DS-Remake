...
execute if score #mansion_type Selected matches 1 if entity @a[advancements={luigis_mansion:lab/cleared_hidden_mansion=false}] run function luigis_mansion_3ds_remake:other/upgrade_path/convert_hidden_data
...
execute if entity @a[advancements={luigis_mansion:lab/cleared_hidden_mansion=true}] run advancement grant @a only luigis_mansion_3ds_remake:lab/unlocked_gcn_hidden_mansion
