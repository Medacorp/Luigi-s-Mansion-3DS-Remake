...
execute if score #temp Money matches 130000.. run data modify storage luigis_mansion_3ds_remake:data current_state.mansion_rank_s_achieved set value 1b
scoreboard players reset #temp Money
scoreboard players reset #temp2 Money
scoreboard players set #temp Time 0
scoreboard players set #temp Money 50
execute if data storage luigis_mansion:data current_state.high_scores[0] run function luigis_mansion_3ds_remake:room/gallery/interact_with_trophy/get_lowest_health
execute if data storage luigis_mansion:data new_high_scores run data modify storage luigis_mansion:data current_state.high_scores set from storage luigis_mansion:data new_high_scores
data remove storage luigis_mansion:data new_high_scores
...
execute if data storage luigis_mansion:data current_state.high_scores[0] run function luigis_mansion_3ds_remake:room/gallery/interact_with_trophy/get_quickest_time
execute if data storage luigis_mansion:data new_high_scores run data modify storage luigis_mansion:data current_state.high_scores set from storage luigis_mansion:data new_high_scores
data remove storage luigis_mansion:data new_high_scores
