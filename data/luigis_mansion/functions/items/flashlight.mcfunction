...
execute if entity @s[scores={IdleTime=..-1},tag=!idle,tag=flashlight] run function luigis_mansion:items/flashlight/effects/turn_off
tag @s[scores={IdleTime=..-1},tag=!idle,tag=flashlight] remove had_flashlight_on
tag @s[scores={IdleTime=..-1},tag=!idle,tag=flashlight] remove flashlight
execute unless entity @s[scores={IdleTime=..-1},tag=!idle] run function #luigis_mansion:items/flashlight/types
