...
data modify storage luigis_mansion_3ds_remake:data current_state.trophy.easy.has_element_medals.fire set value 1b
execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.easy.has_element_medals{fire:1b,water:1b,ice:1b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/3
