...
execute unless score #temp ActionTime matches 2147483647 store result storage luigis_mansion:data current_state.my_money.money.blue_sapphire int 1 run scoreboard players add #temp Time 1
...
execute unless score #temp ActionTime matches 2147483647 store result storage luigis_mansion:data current_state.my_money_data.money.blue_sapphire int 1 run scoreboard players add #temp Time 1
...
scoreboard players set #temp Time 500
