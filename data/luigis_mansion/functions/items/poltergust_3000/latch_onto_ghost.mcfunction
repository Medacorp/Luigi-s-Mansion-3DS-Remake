...
execute if entity @s[tag=!already_included,tag=!vacuumable] at @a[tag=me,scores={Health=41..,Shrunk=0},tag=!gooigi,limit=1] run playsound luigis_mansion:entity.player.latch_onto_ghost.high_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=!already_included,tag=!vacuumable] at @a[tag=me,scores={Health=41..,Shrunk=1..},tag=!gooigi,limit=1] run playsound luigis_mansion:entity.player.latch_onto_ghost.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[tag=!already_included,tag=!vacuumable] at @a[tag=me,scores={Health=..40,Shrunk=0},tag=!gooigi,limit=1] run playsound luigis_mansion:entity.player.latch_onto_ghost.low_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[tag=!already_included,tag=!vacuumable] at @a[tag=me,scores={Health=..40,Shrunk=1..},tag=!gooigi,limit=1] run playsound luigis_mansion:entity.player.latch_onto_ghost.low_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[tag=!already_included,tag=!vacuumable] run scoreboard players set @a[tag=me,tag=!gooigi,limit=1] Sound 20
