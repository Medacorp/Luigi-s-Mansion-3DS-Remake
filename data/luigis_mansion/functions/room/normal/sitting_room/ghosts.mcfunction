...
execute if score #sitting_room Wave matches 3 if score #temp Time matches 0 run function luigis_mansion:room/normal/sitting_room/clear
execute if score #sitting_room Wave matches 2 if score #temp Time matches 0 run function luigis_mansion:room/normal/sitting_room/wave_5
execute if score #sitting_room Wave matches 2 if score #temp Time matches ..2 run function luigis_mansion:room/normal/sitting_room/wave_4
...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.sitting_room{cleared:1b} if entity @a[tag=!blackout] unless score #sitting_room Wave matches -1.. run function luigis_mansion:room/normal/sitting_room/wave_1
