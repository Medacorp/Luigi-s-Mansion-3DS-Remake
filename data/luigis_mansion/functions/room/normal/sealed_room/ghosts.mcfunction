...
execute unless data storage luigis_mansion:data current_state.current_data.rooms.sealed_room{cleared:1b} if entity @a[tag=!blackout] unless score #sealed_room Wave matches 1.. run function luigis_mansion:room/normal/sealed_room/wave_1
