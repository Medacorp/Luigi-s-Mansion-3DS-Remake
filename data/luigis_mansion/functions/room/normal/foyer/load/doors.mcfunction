...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=755.0,y=11,z=8.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add unopenable
...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=755.0,y=11,z=9.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add unopenable
...
tag @e[x=744.0,y=11,z=8.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add foyer_hallway_3
...
tag @e[x=744.0,y=11,z=9.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add foyer_hallway_3