...
execute if entity @e[type=minecraft:marker,tag=chance,tag=selected,tag=money] positioned 667 121 -40 run function luigis_mansion:room/normal/balcony_2/plant_15
