...
tag @e[x=669.0,y=11,z=7.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_6_courtyard
...
execute if data storage luigis_mansion:data current_state.current_data{blackout:1b} run tag @e[x=673.5,y=11,z=10.0,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add fake