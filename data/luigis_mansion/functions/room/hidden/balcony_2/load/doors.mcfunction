...
tag @e[x=682.0,y=120,z=28.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add hallway_17_balcony_2
...
tag @e[x=682.0,y=120,z=-12.5,distance=..0.7,type=minecraft:villager,tag=door,limit=1] add balcony_2_hallway_18