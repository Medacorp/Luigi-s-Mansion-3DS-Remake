...
execute if entity @s[scores={AnimationProg=11..12}] store result entity @s Pose.RightArm[2] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProg=13..16}] store result entity @s Pose.RightArm[2] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={AnimationProg=17..18}] store result entity @s Pose.RightArm[2] float 1 run scoreboard players remove #temp Time 2
...
execute if entity @s[scores={AnimationProg=11..12}] store result entity @s Pose.RightArm[2] float 1 run scoreboard players add #temp Time 2
execute if entity @s[scores={AnimationProg=13..16}] store result entity @s Pose.RightArm[2] float 1 run scoreboard players remove #temp Time 2
execute if entity @s[scores={AnimationProg=17..18}] store result entity @s Pose.RightArm[2] float 1 run scoreboard players add #temp Time 2
