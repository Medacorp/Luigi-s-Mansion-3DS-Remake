...
execute if entity @s[tag=sneaking,tag=!stop_model,tag=!riding_poltergust] run function luigis_mansion:animations/luigi/sneaking/right_leg
execute if entity @s[tag=walking,tag=!stop_model,tag=!riding_poltergust] run function luigis_mansion:animations/luigi/walking/right_leg
execute if entity @s[tag=running,tag=!stop_model,tag=!riding_poltergust] run function luigis_mansion:animations/luigi/running/right_leg
execute if entity @s[tag=swimming,tag=!stop_model,tag=!riding_poltergust] run function luigis_mansion:animations/luigi/swimming/right_leg
...
execute at @s[tag=look] run function luigis_mansion:animations/luigi/look/right_leg
execute at @s[scores={KnockbackType=-9}] run function luigis_mansion_3ds_remake:animations/luigi/search/chest/right_leg
...
execute at @s[scores={KnockbackType=12..13}] run function luigis_mansion:animations/luigi/knockback/flee/right_leg
execute at @s[scores={KnockbackType=14}] run function luigis_mansion:animations/luigi/knockback/fake_door/right_leg
