...
execute if entity @s[scores={Dialog=1..462}] as @a[tag=same_room] unless entity @s[scores={MusicGroup=0,MusicType=10}] run function luigis_mansion:other/music/set/toad
...
execute if entity @s[scores={Dialog=422}] if entity @a[scores={Toad3Choice=1}] if score #mansion_data_index Selected matches 1 run function luigis_mansion_3ds_remake:room/hidden/washroom_1/clear
execute if entity @s[scores={Dialog=422}] if entity @a[scores={Toad3Choice=1}] if score #mansion_data_index Selected matches 0 run function luigis_mansion:room/hidden/washroom_1/clear
...
execute if entity @s[tag=!talk,scores={Dialog=..421},tag=happy] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
