...
execute if entity @s[scores={Dialog=422}] if entity @a[scores={Toad3Choice=1}] run function luigis_mansion_3ds_remake:room/hidden/washroom_1/clear
...
execute if entity @s[scores={Dialog=146}] if entity @a[scores={Toad3Choice=2}] run scoreboard players set @s Dialog 442
