...
execute if entity @s[scores={Dialog=78}] if entity @a[scores={EGaddGPRChoice=2},limit=1] as @a[tag=same_room] run function luigis_mansion_3ds_remake:room/gallery/warp_to
