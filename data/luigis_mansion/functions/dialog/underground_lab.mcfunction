...
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #players Totals matches 1 run tellraw @a[tag=same_room,advancements={luigis_mansion_3ds_remake:amiibo/root=false}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1.alt"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #players Totals matches 2.. run tellraw @a[tag=same_room,advancements={luigis_mansion_3ds_remake:amiibo/root=false}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1.alt.more"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] run playsound luigis_mansion:entity.e_gadd.talk.nohjeebeedoggy_soh_kah_oydohroh neutral @a[tag=same_room,advancements={luigis_mansion_3ds_remake:amiibo/root=false}] ~ ~ ~ 1
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #players Totals matches 1 run tellraw @a[tag=same_room,advancements={luigis_mansion_3ds_remake:amiibo/root=true}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #players Totals matches 2.. run tellraw @a[tag=same_room,advancements={luigis_mansion_3ds_remake:amiibo/root=true}] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1.more"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] run playsound luigis_mansion:entity.e_gadd.talk.odoh_pahn_pahn neutral @a[tag=same_room,advancements={luigis_mansion_3ds_remake:amiibo/root=true}] ~ ~ ~ 1
execute if entity @a[scores={EGaddLabChoice=8},limit=1] if entity @a[advancements={luigis_mansion_3ds_remake:amiibo/root=false},limit=1] run scoreboard players set @s[scores={Dialog=106}] Dialog -1
