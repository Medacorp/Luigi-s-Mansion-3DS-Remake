...
execute if entity @s[scores={Dialog=132}] if entity @a[scores={EGaddLabChoice=4},limit=1] run scoreboard players set @e[tag=this_model,tag=e_gadd_head,limit=1] AnimationProg 0
