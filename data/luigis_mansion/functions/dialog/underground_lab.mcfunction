execute if entity @a[scores={EGaddLabChoice=8},limit=1] if entity @a[scores={AmiiboChoice=1..},limit=1] run scoreboard players add @s[scores={Dialog=125..}] Dialog 1
execute if entity @a[scores={EGaddLabChoice=8},limit=1] run scoreboard players add @s[scores={Dialog=..124}] Dialog 1
execute if entity @a[scores={EGaddLabChoice=1..},limit=1] unless entity @a[scores={EGaddLabChoice=8},limit=1] run scoreboard players add @s[scores={Dialog=57..}] Dialog 1
...
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=7},limit=1] if entity @a[tag=gooigi] run tag @s add gooigi_exists
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=7},limit=1] if score #players Totals matches 1 run tag @s add cannot_change
execute if entity @s[scores={Dialog=58},tag=gooigi_exists] if entity @a[scores={EGaddLabChoice=7},limit=1] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.leave_gooigi.1"}]}
execute if entity @s[scores={Dialog=58},tag=gooigi_exists] if entity @a[scores={EGaddLabChoice=7},limit=1] run playsound luigis_mansion:entity.e_gadd.talk.seedapee_ohyah neutral @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=82},tag=gooigi_exists] if entity @a[scores={EGaddLabChoice=7},limit=1] as @a[tag=gooigi,limit=1] run function luigis_mansion_3ds_remake:entities/player/un_gooigi
execute if entity @s[scores={Dialog=82},tag=gooigi_exists] if entity @a[scores={EGaddLabChoice=7},limit=1] positioned 784 77 12 run function luigis_mansion_3ds_remake:spawn_entities/gooigi/lab
execute if entity @s[scores={Dialog=82},tag=gooigi_exists] if entity @a[scores={EGaddLabChoice=7},limit=1] run scoreboard players set @s Dialog -1
execute if entity @s[scores={Dialog=58},tag=!gooigi_exists,tag=!cannot_change] if entity @a[scores={EGaddLabChoice=7},limit=1] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.use_gooigi.1"}]}
execute if entity @s[scores={Dialog=58},tag=!gooigi_exists,tag=!cannot_change] if entity @a[scores={EGaddLabChoice=7},limit=1] run playsound luigis_mansion:entity.e_gadd.talk.tatta_tatta neutral @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=82},tag=!gooigi_exists,tag=!cannot_change] as @a[scores={EGaddLabChoice=7},limit=1] run tag @e[tag=gooigi,limit=1] add remove_from_existence
execute if entity @s[scores={Dialog=82},tag=!gooigi_exists,tag=!cannot_change] as @a[scores={EGaddLabChoice=7},limit=1] run tag @e[tag=gooigi_model] add remove_from_existence
execute if entity @s[scores={Dialog=82},tag=!gooigi_exists,tag=!cannot_change] as @a[scores={EGaddLabChoice=7},limit=1] run function luigis_mansion_3ds_remake:entities/player/gooigi_fy
execute if entity @s[scores={Dialog=82},tag=!gooigi_exists,tag=!cannot_change] if entity @a[scores={EGaddLabChoice=7},limit=1] run scoreboard players set @s Dialog -1
execute if entity @s[scores={Dialog=58},tag=!gooigi_exists,tag=cannot_change] if entity @a[scores={EGaddLabChoice=7},limit=1] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.use_gooigi.1.alt"}]}
execute if entity @s[scores={Dialog=58},tag=!gooigi_exists,tag=cannot_change] if entity @a[scores={EGaddLabChoice=7},limit=1] run playsound luigis_mansion:entity.e_gadd.talk.nohjeebeedoggy_ohmoogah neutral @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=106},tag=!gooigi_exists,tag=cannot_change] if entity @a[scores={EGaddLabChoice=7},limit=1] run scoreboard players set @s Dialog -1
execute if entity @s[scores={Dialog=58..}] if entity @a[scores={EGaddLabChoice=8},limit=1] run function #luigis_mansion_3ds_remake:dialog/amiibo
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] unless score #amiibo_available Selected matches 1 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1.alt"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] unless score #amiibo_available Selected matches 1 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1.alt.more"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] unless score #amiibo_available Selected matches 1 run playsound luigis_mansion:entity.e_gadd.talk.nohjeebeedoggy_soh_kah_oydohroh neutral @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #amiibo_available Selected matches 1 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #amiibo_available Selected matches 1 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.underground_lab.change_amiibo.1.more"}]}
execute if entity @s[scores={Dialog=58}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #amiibo_available Selected matches 1 run playsound luigis_mansion:entity.e_gadd.talk.odoh_pahn_pahn neutral @a[tag=same_room] ~ ~ ~ 1
execute if entity @a[scores={EGaddLabChoice=8},limit=1] unless score #amiibo_available Selected matches 1 run scoreboard players set @s[scores={Dialog=106}] Dialog -1
execute if entity @a[scores={EGaddLabChoice=8},limit=1] if entity @s[scores={Dialog=124..125}] as @a[tag=same_room,tag=!spectator,tag=!thinking,tag=!looking_at_map] run function luigis_mansion:entities/player/animation/set/thinking
execute if entity @a[scores={EGaddLabChoice=8},limit=1] if score #amiibo_available Selected matches 1 run tag @s[scores={Dialog=124}] add listen
execute if entity @a[scores={EGaddLabChoice=8},limit=1] if score #amiibo_available Selected matches 1 run tag @s[scores={Dialog=124}] remove nod
...
execute if entity @s[scores={Dialog=124}] if entity @a[scores={EGaddLabChoice=8},limit=1] if score #amiibo_available Selected matches 1 run tellraw @a[tag=same_room] {"translate":"luigis_mansion:dialog.underground_lab.nowhere","color":"green","clickEvent":{"action":"run_command","value":"/trigger AmiiboChoice set 1"}}
...
execute if entity @s[scores={Dialog=166}] if entity @a[scores={EGaddLabChoice=8},limit=1] if entity @a[scores={AmiiboChoice=2..},limit=1] run scoreboard players set @s Dialog -1
