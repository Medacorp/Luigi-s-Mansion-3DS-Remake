...
execute if entity @s[scores={Dialog=82}] if entity @a[scores={EGaddLabChoice=2},limit=1] as @a[tag=same_room] run function luigis_mansion_3ds_remake:entities/e_gadd/to_gallery
...
execute if entity @s[scores={Dialog=74}] if entity @a[scores={EGaddLabChoice=6},limit=1] run scoreboard players set @s Dialog 148
