...
execute if entity @s[scores={Dialog=1..874}] as @a[tag=same_room] unless entity @s[scores={MusicGroup=0,MusicType=10}] run function luigis_mansion:other/music/set/toad
...
execute if entity @s[scores={Dialog=786}] if entity @a[scores={Toad4Choice=1}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=730}] if entity @a[scores={Toad4Choice=2}] run scoreboard players set @s Dialog 874
...
execute if entity @s[tag=!talk,scores={Dialog=..873},tag=happy] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
