...
execute if entity @s[scores={Dialog=1..894}] as @a[tag=same_room] unless entity @s[scores={MusicGroup=0,MusicType=10}] run function luigis_mansion:other/music/set/toad
...
execute if entity @s[scores={Dialog=256}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=806}] if entity @a[scores={Toad4Choice=1}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=806}] if entity @a[scores={Toad4Choice=1}] run playsound luigis_mansion:entity.toad.yahoo neutral @a[tag=same_room] ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=706}] if entity @a[scores={Toad4Choice=2}] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.toad_4.no.1"}]}
execute if entity @s[scores={Dialog=730}] if entity @a[scores={Toad4Choice=2}] run scoreboard players set @s Dialog 894
...
execute if entity @s[tag=!talk,scores={Dialog=..893},tag=happy] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
