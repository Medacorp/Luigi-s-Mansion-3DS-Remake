...
execute if entity @s[scores={Dialog=1..1264}] as @a[tag=same_room] unless entity @s[scores={MusicGroup=0,MusicType=10}] run function luigis_mansion:other/music/set/toad
...
execute if entity @s[scores={Dialog=112}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=224}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=728}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=946}] if entity @a[scores={Toad1Choice=1}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
execute if entity @s[scores={Dialog=1042}] run function luigis_mansion_3ds_remake:room/hidden/foyer/clear
execute if entity @s[scores={Dialog=1042}] run function luigis_mansion_3ds_remake:room/hidden/hallway_1/clear
tag @s[scores={Dialog=1062}] add explaining
execute if entity @s[scores={Dialog=1062}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
...
tag @s[scores={Dialog=1214}] remove explaining
execute if entity @s[scores={Dialog=1214}] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
execute if entity @s[scores={Dialog=1214}] run scoreboard players set @a Toad1Choice 0
execute if entity @s[scores={Dialog=1214}] run tellraw @a[tag=same_room] {"translate":"luigis_mansion:message.save.yes","color":"green","clickEvent":{"action":"run_command","value":"/trigger Toad1Choice set 1"},"extra":[{"text":"\n"},{"translate":"luigis_mansion:message.save.no","clickEvent":{"action":"run_command","value":"/trigger Toad1Choice set 2"}}]}
execute if entity @s[scores={Dialog=1214}] run scoreboard players enable @a[tag=same_room] Toad1Choice
execute if entity @s[scores={Dialog=1216}] as @a[scores={Toad1Choice=1},limit=1] run function luigis_mansion:data/save
execute if entity @s[scores={Dialog=1216}] run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.toad","color":"green"},{"translate":"luigis_mansion:dialog.toad_1.yes.3"}]}
...
execute if entity @s[tag=!talk,scores={Dialog=..1041},tag=happy] run scoreboard players set @e[tag=this_model,tag=toad_head,limit=1] AnimationProg 0
