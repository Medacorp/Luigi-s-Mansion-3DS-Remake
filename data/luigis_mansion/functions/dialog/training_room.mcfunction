...
execute if entity @s[scores={Dialog=2177}] if score #training GhostCaught matches 11 as @a[tag=same_room,limit=1] at @s unless entity @a[tag=same_room,distance=0.1..,limit=1] run advancement grant @s only luigis_mansion:challenges/who_you_gonna_call
execute if entity @s[scores={Dialog=2177}] if score #training GhostCaught matches 11 if score #players Totals matches 1 run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.23.11","with":[{"selector":"@a[gamemode=!spectator]"}]}]}
execute if entity @s[scores={Dialog=2177}] if score #training GhostCaught matches 11 if score #players Totals matches 2.. run tellraw @a[tag=same_room] {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.training_room.23.11.more"}]}
execute if entity @s[scores={Dialog=2177}] if score #training GhostCaught matches 11 run scoreboard players add @s Dialog 16
