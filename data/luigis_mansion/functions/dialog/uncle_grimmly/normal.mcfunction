...
execute if entity @s[scores={Dialog=24}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.gay_roon_ehdeedee_odoh_tahmentahkeh neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=144}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.soh_suu_suhm_ehdeedee_ck_ck_suku_suku neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=320}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.ohyah_mee neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=340}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.oui_soh_suu_suhm_ck_ck neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=444}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.suku_suku_oui_soh_suu_suhm_tahmehno_tahkeh neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=628}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.oh_tohmah_poheh_jeemee_jeemee_pen_pen neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=884}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.hey_hey_nohjeebeedoggy_oomahkah_ooh_ooh neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={Dialog=1124}] as @a at @s run playsound luigis_mansion:entity.e_gadd.talk.luigi_oui neutral @s ~ ~ ~ 1
execute if entity @s[scores={Dialog=1244}] run function luigis_mansion:room/normal/telephone_room/blackout
