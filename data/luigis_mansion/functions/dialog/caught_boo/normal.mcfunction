...
execute if entity @s[scores={GBHDialog=1,Variant=17}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.17","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=17}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.17.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=17}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.mee_oomahkah_suku_suku_yahboh_yahboh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=296,Variant=17}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=18}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.18","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=18}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.18.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=18}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.soy_soh_ooh_soh_kah_ck_ck neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=288,Variant=18}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=19}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.19","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=19}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.19.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=19}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.hap_poh_oomahkah_tatta_tatta neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=72,Variant=19}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=20}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.20"}]}
execute if entity @s[scores={GBHDialog=1,Variant=20}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.20.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=20}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.pen_pen_odoh_mah_mah_poheh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=64,Variant=20}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=21}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.21","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=21}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.21.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=21}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.ooh_ooh_yahboh_yahboh_hoo_hoo_hoo neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=120,Variant=21}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=22}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.22"}]}
execute if entity @s[scores={GBHDialog=1,Variant=22}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.22.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=22}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.hap_poh_oomahkah_tatta_tatta neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=96,Variant=22}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=23}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.23","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=23}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.23.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=23}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.mm_nohjeebeedoggy_ohyah_oydohroh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=160,Variant=23}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=24}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.24","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=24}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.24.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=24}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.nohjeebeedoggy_oui_oohmakah_tahmentahkeh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=80,Variant=24}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=25}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.25","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=25}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.25.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=25}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.orohroh_odoh_pahn_pahn neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=88,Variant=25}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=26}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.25","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=26}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.25.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=26}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.nohjeebeedoggy_oui_oohmakah_tahmentahkeh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=168,Variant=26}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=27}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.25","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=27}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.25.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=27}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.pen_pen_odoh_mah_mah_poheh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=96,Variant=27}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=..-3}] unless entity @s[scores={Variant=-4}] unless entity @s[scores={Variant=-8..-7}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.caught_boo.extra"}]}
execute if entity @s[scores={GBHDialog=1,Variant=..-3}] unless entity @s[scores={Variant=-4}] unless entity @s[scores={Variant=-8..-7}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.caught_boo.extra.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=..-3}] unless entity @s[scores={Variant=-4}] unless entity @s[scores={Variant=-8..-7}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.mm_nohjeebeedoggy_ohyah_oydohroh neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={GBHDialog=112,Variant=-3}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.soy_soh_ooh_oh_tohmah_tahmehno_tahkeh_bohh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=320,Variant=-3}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=-4}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.tenth_boo.1","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=-4}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.tenth_boo.1.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=-4}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.mm_nohjeebeedoggy_ohyah_oydohroh neutral @s ~ ~ ~ 1
execute if entity @s[scores={GBHDialog=192,Variant=-4}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.caught_boo.extra.2"}]}
execute if entity @s[scores={GBHDialog=192,Variant=-4}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion:dialog.caught_boo.extra.2.more"}]}
execute if entity @s[scores={GBHDialog=192,Variant=-4}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.ohmoogah_luigi_odoh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=424,Variant=-4}] GBHDialog 10000
...
execute if entity @s[scores={GBHDialog=112,Variant=-5}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.oomahkah_oui_soy_soh_ooh_ck_ck neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={GBHDialog=112,Variant=-6}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.ohyah_squirtbottlelaugh_bohh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=376,Variant=-6}] GBHDialog 10000
execute if entity @s[scores={GBHDialog=1,Variant=-7}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.twenyth_boo.1","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=-7}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.twenyth_boo.1.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=-7}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.soy_soh_ooh_soh_kah_ck_ck neutral @s ~ ~ ~ 1
execute if entity @s[scores={GBHDialog=184,Variant=-7}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.extra.5"}]}
execute if entity @s[scores={GBHDialog=184,Variant=-7}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.extra.5.more"}]}
execute if entity @s[scores={GBHDialog=184,Variant=-7}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.ohyah_squirtbottlelaugh_bohh neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=344,Variant=-7}] GBHDialog 10000
...
execute if entity @s[scores={GBHDialog=1,Variant=-8}] if score #players Totals matches 1 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.last_boo.1","with":[{"selector":"@p[gamemode=!spectator]"}]}]}
execute if entity @s[scores={GBHDialog=1,Variant=-8}] if score #players Totals matches 2.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.e_gadd","color":"green"},{"translate":"luigis_mansion_3ds_remake:dialog.caught_boo.last_boo.1.more"}]}
execute if entity @s[scores={GBHDialog=1,Variant=-8}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.soy_soh_ooh_soh_kah_ck_ck neutral @s ~ ~ ~ 1
scoreboard players set @s[scores={GBHDialog=416,Variant=-8}] GBHDialog 10000
...
execute if entity @s[scores={GBHDialog=10368,Variant=-2}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.bohh_squirtbottlelaugh neutral @s ~ ~ ~ 1
...
execute if entity @s[scores={GBHDialog=10098}] unless entity @s[scores={Variant=-2}] as @a[tag=same_room] at @s run playsound luigis_mansion:entity.e_gadd.talk.yahmum_baah neutral @s ~ ~ ~ 1
