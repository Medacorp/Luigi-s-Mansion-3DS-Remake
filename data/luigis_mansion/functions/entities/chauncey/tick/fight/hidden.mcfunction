...
execute unless entity @e[type=minecraft:armor_stand,tag=ball,scores={Room=73}] run scoreboard players set @s[scores={Dialog=381..581},tag=!laugh,tag=intro_done] Dialog 0
