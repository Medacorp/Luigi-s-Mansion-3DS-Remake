...
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 70000..99999 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.the_end.b_rank"}]}
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 100000..129999 run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion:message.the_end.a_rank"}]}
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 130000.. run tellraw @a {"translate":"chat.type.text","with":[{"translate":"luigis_mansion:entity.mansion","color":"green"},{"translate":"luigis_mansion_3ds_remake:message.the_end.s_rank"}]}
...
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 70000..99999 run advancement grant @a only luigis_mansion:lab/b_rank
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 100000..129999 run advancement grant @a only luigis_mansion:lab/a_rank
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 130000.. run advancement grant @a only luigis_mansion:lab/s_rank
