...
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 70000..99999 run advancement grant @a[tag=same_room] only luigis_mansion:lab/b_rank
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 100000..129999 run advancement grant @a[tag=same_room] only luigis_mansion:lab/a_rank
execute if entity @s[scores={Dialog=639}] if score #temp Money matches 130000.. run advancement grant @a[tag=same_room] only luigis_mansion:lab/s_rank
