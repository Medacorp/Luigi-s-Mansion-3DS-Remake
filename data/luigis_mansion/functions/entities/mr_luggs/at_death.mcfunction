...
teleport @s ~ -100 ~
execute if entity @s[scores={TopVacuumDamage=14000..}] run data modify storage luigis_mansion:data current_state.current_data.portrait_ghosts.mr_luggs.rank set value 3b
execute if entity @s[scores={TopVacuumDamage=9000..13999}] run data modify storage luigis_mansion:data current_state.current_data.portrait_ghosts.mr_luggs.rank set value 2b
