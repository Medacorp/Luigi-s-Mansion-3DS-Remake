...
execute if entity @s[tag=fight] run function #luigis_mansion:entities/boolossus/fight
execute if entity @s[tag=!fight,tag=!split] run function #luigis_mansion:entities/boolossus/balcony
