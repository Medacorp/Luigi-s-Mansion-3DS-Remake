...
teleport @s ~ -100 ~
execute unless entity @e[tag=boolossus,tag=!dead,limit=1] run function luigis_mansion:entities/ghost/boss_damage
...
execute unless entity @e[tag=boolossus,tag=!dead,limit=1] run advancement grant @a only luigis_mansion:portrait_ghosts/boolossus
