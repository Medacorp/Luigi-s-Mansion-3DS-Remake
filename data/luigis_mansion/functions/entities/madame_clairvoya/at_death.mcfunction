...
teleport @s ~ -100 ~
execute if entity @s[scores={TopVacuumDamage=140..}] run data modify storage luigis_mansion:data current_state.current_data.portrait_ghosts.madame_clairvoya.rank set value 3b
execute if entity @s[scores={TopVacuumDamage=90..139}] run data modify storage luigis_mansion:data current_state.current_data.portrait_ghosts.madame_clairvoya.rank set value 2b
execute if entity @s[scores={TopVacuumDamage=50..89}] run data modify storage luigis_mansion:data current_state.current_data.portrait_ghosts.madame_clairvoya.rank set value 1b
