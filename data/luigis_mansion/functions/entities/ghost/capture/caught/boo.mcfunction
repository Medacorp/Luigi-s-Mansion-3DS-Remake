...
execute if data luigis_mansion_3ds_remake:data current_state.trophy.hard{task_9:0b} run function #luigis_mansion_3ds_remake:room/gallery/interact_with_trophy/get_boo_count
execute if score #temp Time matches 20.. if data luigis_mansion_3ds_remake:data current_state.trophy.easy{task_9:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/9
execute if score #temp Time matches 50.. if data luigis_mansion_3ds_remake:data current_state.trophy.hard{task_9:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/hard/9
