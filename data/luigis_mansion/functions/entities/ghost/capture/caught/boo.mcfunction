...
execute if score #temp Time matches 20.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.easy{task_9:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/task_9
execute if score #temp Time matches 50.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.hard{task_9:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/hard/task_9
