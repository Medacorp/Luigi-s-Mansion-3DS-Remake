...
execute in minecraft:overworld if block 27 0 0 minecraft:shulker_box{Items:[{tag:{first_run_only:1b}}]} run execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.hard{task_9:0b} run function #luigis_mansion_3ds_remake:room/gallery/interact_with_trophy/get_boo_count
execute in minecraft:overworld if block 27 0 0 minecraft:shulker_box{Items:[{tag:{first_run_only:1b}}]} run execute if score #temp Time matches 20.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.easy{task_9:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/task_9
execute in minecraft:overworld if block 27 0 0 minecraft:shulker_box{Items:[{tag:{first_run_only:1b}}]} run execute if score #temp Time matches 50.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.hard{task_9:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/hard/task_9
