...
execute if score #temp ActionTime matches 1.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.easy{task_6:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/6
execute if score #temp ActionTime matches 30.. if data storage luigis_mansion_3ds_remake:data current_state.trophy.hard{task_8:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/hard/8
