...
execute if score #temp ActionTime matches 1.. if data luigis_mansion_3ds_remake:data current_state.trophy.easy{task_5:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/5
execute if score #temp ActionTime matches 20.. if data luigis_mansion_3ds_remake:data current_state.trophy.hard{task_7:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/hard/7
