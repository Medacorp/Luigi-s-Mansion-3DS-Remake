...
execute if score #temp ActionTime matches 10.. if data luigis_mansion_3ds_remake:data current_state.trophy.beginner{task_4:0b} run function luigis_mansion_3ds_remake:room/gallery/clear_task/beginner/4
