...
data remove storage luigis_mansion:data current_state.new_ghosts_caught
execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.beginner{task_1:0b} if score #temp Time matches 50.. run function luigis_mansion_3ds_remake:room/gallery/clear_task/beginner/task_1
execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.easy{task_1:0b} if score #temp Time matches 100.. run function luigis_mansion_3ds_remake:room/gallery/clear_task/easy/task_1
execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.normal{task_1:0b} if score #temp Time matches 250.. run function luigis_mansion_3ds_remake:room/gallery/clear_task/normal/task_1
execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.hard{task_1:0b} if score #temp Time matches 500.. run function luigis_mansion_3ds_remake:room/gallery/clear_task/hard/task_1
execute if data storage luigis_mansion_3ds_remake:data current_state.trophy.master{task_1:0b} if score #temp Time matches 1000.. run function luigis_mansion_3ds_remake:room/gallery/clear_task/master/task_1
