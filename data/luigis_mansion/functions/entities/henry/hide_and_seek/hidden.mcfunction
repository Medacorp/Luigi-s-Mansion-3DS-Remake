...
execute if entity @s[scores={Dialog=1},tag=next_wave] run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/add_blockade
...
execute if entity @s[scores={Dialog=120},tag=next_wave] run function luigis_mansion_3ds_remake:room/hidden/the_twins_room/wave_6
