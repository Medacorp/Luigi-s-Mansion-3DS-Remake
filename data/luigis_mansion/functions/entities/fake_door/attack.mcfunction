...
execute if entity @s[scores={ActionTime=1}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_scare.high_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=1}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_scare.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={ActionTime=1}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_scare.low_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=1}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_scare.low_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={ActionTime=1}] run scoreboard players set @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0},tag=!gooigi] Sound 5
execute if entity @s[scores={ActionTime=6}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_little player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=6}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.hurt_little player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={ActionTime=6}] run scoreboard players set @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0},tag=!gooigi] Sound 29
execute if entity @s[scores={ActionTime=35}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.sigh.high_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=35}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.sigh.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={ActionTime=35}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.sigh.low_health player @a[tag=same_room] ~ ~ ~ 1
execute if entity @s[scores={ActionTime=35}] at @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.sigh.low_health player @a[tag=same_room] ~ ~ ~ 1 2
execute if entity @s[scores={ActionTime=35}] run scoreboard players set @p[tag=door_target,distance=..3,scores={KnockbackTime=10,KnockbackType=1,Sound=0},tag=!gooigi] Sound 20
