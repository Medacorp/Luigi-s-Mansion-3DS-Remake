...
execute at @s[scores={KnockbackTime=20..,KnockbackType=4},tag=!gooigi] if score #mirrored Selected matches 0 run teleport @s ^ ^ ^ ~-10 ~
execute at @s[scores={KnockbackTime=20..,KnockbackType=4},tag=!gooigi] if score #mirrored Selected matches 1 run teleport @s ^ ^ ^ ~10 ~
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] run summon minecraft:marker ~ ~ ~ {Tags:["home"]}
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] store result entity @e[tag=home,limit=1] Pos[0] double 0.01 run scoreboard players get @s PosX
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] store result entity @e[tag=home,limit=1] Pos[1] double 0.01 run scoreboard players get @s PosY
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] store result entity @e[tag=home,limit=1] Pos[2] double 0.01 run scoreboard players get @s PosZ
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] store result entity @e[tag=home,limit=1] Rotation[0] float 0.01 run scoreboard players get @s RotY
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] store result entity @e[tag=home,limit=1] Rotation[1] float 0.01 run scoreboard players get @s RotX
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] at @e[tag=home,limit=1] run tp @s ~ ~ ~ ~ ~
execute at @s[scores={KnockbackTime=1..,KnockbackType=4},tag=gooigi] run kill @e[tag=home,limit=1]
