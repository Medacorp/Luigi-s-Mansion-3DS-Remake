...
execute at @s[scores={KnockbackTime=1..,KnockbackType=5},tag=gooigi] at @e[tag=home,limit=1] run tp @s ~ 0 ~ ~ ~
...
scoreboard players set @s[scores={KnockbackTime=1..,KnockbackType=8..10,Sound=0},tag=!gooigi] Sound 2
