...
execute at @s[scores={KnockbackType=5},tag=gooigi] run summon minecraft:marker ~ ~ ~ {Tags:["home"]}
...
execute at @s[scores={KnockbackType=6}] run summon minecraft:marker ~ ~ ~ {Tags:["home"]}
...
execute at @s[scores={KnockbackType=7}] run summon minecraft:marker ~ ~ ~ {Tags:["home"]}
