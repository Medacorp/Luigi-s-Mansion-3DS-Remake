...
scoreboard players set @s[scores={ScareTime=20,ScareType=1},tag=!gooigi] Sound 20
...
execute at @s[scores={ScareTime=100,ScareType=2,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.high_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=100,ScareType=2,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute at @s[scores={ScareTime=100,ScareType=2,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.low_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=100,ScareType=2,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.low_health player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={ScareTime=100,ScareType=2},tag=!gooigi] Sound 60
...
execute at @s[scores={ScareTime=51,ScareType=3..4,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed.high_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=51,ScareType=3..4,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute at @s[scores={ScareTime=51,ScareType=3..4,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed.low_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=51,ScareType=3..4,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed.low_health player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={ScareTime=51,ScareType=3..4},tag=!gooigi] Sound 30
...
execute at @s[scores={ScareTime=20,ScareType=3..4,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.recover.high_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=20,ScareType=3..4,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.recover.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute at @s[scores={ScareTime=20,ScareType=3..4,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.recover.low_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=20,ScareType=3..4,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.recover.low_health player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={ScareTime=20,ScareType=3..4},tag=!gooigi] Sound 20
