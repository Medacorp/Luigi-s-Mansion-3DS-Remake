...
execute at @s[scores={ScareTime=51,ScareType=2},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=22..,ScareType=2}] positioned as @e[type=minecraft:marker,tag=temp,limit=1] run teleport @s ^ ^ ^
...
execute at @s[scores={ScareTime=..20,ScareType=2}] positioned as @e[type=minecraft:marker,tag=temp,limit=1] run teleport @s ^ ^ ^
scoreboard players remove @s[scores={ScareType=2,ScareTime=..20}] ScareTime 1
execute unless entity @s[scores={MaxHealthTime=1..}] run scoreboard players remove @s[scores={ScareType=2,ScareTime=21}] ScareTime 1
scoreboard players remove @s[scores={ScareType=2,ScareTime=22..}] ScareTime 1
