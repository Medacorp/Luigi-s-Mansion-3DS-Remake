...
execute at @s[scores={ScareTime=20,ScareType=1,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=20,ScareType=1,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare player @a[tag=same_room] ~ ~ ~ 1 2
...
execute at @s[scores={ScareTime=51,ScareType=2..3,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=51,ScareType=2..3,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_bashed player @a[tag=same_room] ~ ~ ~ 1 2
