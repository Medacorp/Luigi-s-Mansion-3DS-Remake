...
execute at @s[scores={ScareTime=80,ScareType=2,Health=41..,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.high_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=80,ScareType=2,Health=41..,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.high_health player @a[tag=same_room] ~ ~ ~ 1 2
execute at @s[scores={ScareTime=80,ScareType=2,Health=..40,Shrunk=0},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.low_health player @a[tag=same_room] ~ ~ ~ 1
execute at @s[scores={ScareTime=80,ScareType=2,Health=..40,Shrunk=1..},tag=!gooigi] run playsound luigis_mansion:entity.player.scare_freeze.low_health player @a[tag=same_room] ~ ~ ~ 1 2
scoreboard players set @s[scores={ScareTime=80,ScareType=2},tag=!gooigi] Sound 60
