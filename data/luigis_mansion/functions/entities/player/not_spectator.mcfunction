...
execute if entity @s[scores={Talk=1..,IdleTime=0..},tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving,tag=!gooigi] run function luigis_mansion:target_villager
