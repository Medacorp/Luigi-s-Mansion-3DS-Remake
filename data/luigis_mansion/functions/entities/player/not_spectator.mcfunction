...
execute if entity @s[tag=!looking_at_map,tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={KnockbackType=2..}] unless entity @s[scores={ScareType=2..}] unless entity @a[scores={GBHCall=1..},limit=1] run function #luigis_mansion:items
execute if entity @s[tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={KnockbackType=2..}] unless entity @s[scores={ScareType=2..}] run function luigis_mansion:items/gameboy_horror
execute if entity @s[tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving] unless entity @s[scores={KnockbackType=2..}] unless entity @s[scores={ScareType=2..}] unless entity @a[scores={GBHCall=1..},limit=1] run function luigis_mansion:blocks/gravity_swap
