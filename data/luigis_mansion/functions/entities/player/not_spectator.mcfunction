...
execute if entity @s[scores={Talk=1..,IdleTime=0..},tag=!death_animation,tag=!revive_animation,tag=!polterpup_reviving,tag=!gooigi] unless entity @s[scores={KnockbackType=1..}] unless entity @s[scores={ScareType=1..}] unless entity @s[scores={Dialog=1..}] run function luigis_mansion:target_villager
